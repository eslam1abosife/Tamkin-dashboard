      ...
      >
        ...
        >
          <div class="relative">
            ...
            <div
            @click="modalStore.controlTeamEditPictureModal"  class=" cursor-pointer absolute bottom-0 right-0 w-[20px] h-[20px] bg-white rounded-full border-[1px] border-[#2CA9A0] flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
