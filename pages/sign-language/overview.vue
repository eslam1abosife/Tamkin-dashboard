...
<template>
    <div class="relative h-full w-full">
      ...
      <LanguageServicesOverviewNavbar :selected-tab="selectTab" @select-tabs="getSelectedTab" />

   <div v-if="selectTab === 'webplugins'">
    <OverviewWidgetembdedcode v-if="!overviewStore.showUpgradeState" class="!mt-[120px]" />
...
<LazyLanguageServicesOverviewTranslationaccuracy v-if="overviewStore.showUpgradeState"/>
   ...
   <div v-if="selectTab === 'Media'">
    <LazyOverviewConnectwithus class="mt-[120px]" v-if="!upgradePackage" />

    <LanguageServicesOverviewPlan @change-plan="currentPlanchange" v-if="upgradePackage" type="pro"    media-type="media"/>
    <LanguageServicesOverviewCurrentPlanMedia v-if="!upgradePackage"
    :plan-type="plan"
    media-type="photos"
    :is-installed="false"
@changePlan="currentPlanchange"
  />
    <LazyLanguageServicesOverviewUsagereports v-if="upgradePackage"/>
  ...
  >
    ...
    <LazyOverviewTamkintokenbanner   :class="[upgradePackage ? '' :'!mt-[30px]']" />
    <LazyOverviewExclusiveinvestorpackage  v-if="upgradePackage"/> 

    <OverviewExclusiveinvestorpackage v-if="!upgradePackage"/>
        </div>

        <div v-if="selectTab === 'Documents'">
          <LazyOverviewConnectwithus class="mt-[120px]" v-if="!upgradePackagedocs" />
          <LanguageServicesOverviewCurrentPlanMedia v-if="!upgradePackagedocs"
          :plan-type="plan"
          media-type="docs"
          :is-installed="false"
      @changePlan="currentPlanchange"
        />
          <LanguageServicesOverviewPlan @change-plan="currentPlanchange" v-else-if="upgradePackagedocs" type="pro"    media-type="docs"/>

          <LazyLanguageServicesOverviewUsagereports v-if="upgradePackagedocs"/>
        ...
        >
          ...
          <LazyOverviewTamkintokenbanner :class="[upgradePackagedocs ? '' :'!mt-[30px]']" />
          <LazyOverviewExclusiveinvestorpackage  v-if="upgradePackagedocs"/> 
      
          <OverviewExclusiveinvestorpackage v-if="!upgradePackagedocs"/>
              </div>
              <div v-if="selectTab === 'Images'">
                <LazyOverviewConnectwithus class="mt-[120px]" v-if="!upgradepackageimages" />
                <LanguageServicesOverviewCurrentPlanMedia v-if="!upgradepackageimages"
                :plan-type="plan"
                media-type="photos"
                :is-installed="false"
            @changePlan="currentPlanchange"
              />
                <LanguageServicesOverviewPlan @change-plan="currentPlanchange" v-else-if="upgradepackageimages" type="pro" 
                   media-type="photos"/>
      
                <LazyLanguageServicesOverviewUsagereports v-if="upgradepackageimages"/>
              ...
              >
                ...
                <LazyOverviewTamkintokenbanner  />
                <LazyOverviewExclusiveinvestorpackage  v-if="upgradepackageimages"/> 
      ...
      <LanguageServicesOverviewTranslationaccuracytable/>
          ...
          <LazyOverviewTamkintokenbanner   class="!mt-[30px]"/>
