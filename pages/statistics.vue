  ...
  <div class="relative h-full w-full">
    <div class="w-full h-full relative">
      <div class="space-y-[10px]">
        <h1 class="ltr:text-left rtl:text-right text-[24px] leading-[36px] font-[600]">Statistics</h1>

        <h2 class="ltr:text-left rtl:text-right text-[15px] font-[400] leading-[22.5px] text-darkGrey">
          Statistics involves collecting, analyzing, and interpreting data to provide
          useful insights.
        </h2>
      </div>
      ...
      >
        <div class="flex items-center justify-start flex-1">
          ...
          <div class="ml-[13px]">
            <h1 class="text-[16px] leading-[22px] font-[500] text-[#23262F]">
              Google Analytics
            </h1>
        ...
        >
          ...
          <table class="min-w-full leading-normal">
            <thead>
              <tr>
                <th
                  class="py-3 border-b-2 w-full border-gray-200 bg-white ltr:text-left rtl:text-right text-[14px] font-[400] leading-[18px] text-black"
                >
                  languages
                </th>
...
.tamkin_date_input {
  ...
  @apply rtl:pr-[14px] ltr:pl-[14px] text-[15px] w-full  h-[32px] rounded-[10px] border-[1px] border-[#585B5B8C] focus:!outline-0;
}
