                    ...
                    <td class="px-6 py-3 text-left ">
                      <div class="flex items-center ml-1 space-x-[4px]">
                        <img :src="getStatusImage(order['order status'])"
                         alt="Placeholder" :class="order['order status'] == 'Declined' ? 'w-[14px] h-[14px]':'w-[24px] h-[24px] ' "/>
      ...
      <div v-if="orders.length>0" class="flex flex-col lg:flex-row md:flex-row justify-between items-center pb-[16px] mt-[16px]">
        <div class="flex items-center rtl:space-x-reverse space-x-2 mb-4 lg:mb-0">
          ...
          <div class="flex space-x-2 rtl:space-x-reverse">
            ...
            <button
              :class="['px-3 py-1 rounded-md text-white focus:outline-none !text-[13px]', { 'bg-[#2dada3]': pageSize === 20, 'bg-[#A7A7A7]': pageSize !== 20 }]"
              @click="setPageSize(20)"
            >
              20
            </button>
            <button
              :class="['px-3 py-1 rounded-md text-white focus:outline-none !text-[13px]', { 'bg-[#2dada3]': pageSize === 50, 'bg-[#A7A7A7]': pageSize !== 50 }]"
          ...
          <div class="flex space-x-2 rtl:space-x-reverse">
            ...
            <button
              ...
              :class="[
                ...
                { 'bg-gradient-to-b from-[#2dada3] to-[#71dad2] text-white': currentPage === page, 'hover:bg-light-grey': currentPage !== page }
              ]"
            >
              {{ page }}
            </button>
