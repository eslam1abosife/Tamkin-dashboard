              ...
              <h3 class="text-[15px] lg:text-[20px] font-[600] text-darkGrey  mb-[23px]" style="line-height: 48px;">
                ...
                <div class="space-y-[23px] w-full ">
                  <div class="w-full relative">
                    <input type="text" placeholder="{{$t('full name')}}" id="email" class="input_floating_label peer" v-model="v$.fullName.$model" :class="{
                        input_error:
                    ...
                    <div class="w-full lg:w-4/6 mt-2" v-if="(v$.fullName.$error && v$.fullName.required.$invalid)">
                      <p class="error_message">
                        <span v-if="v$.fullName.$error && v$.fullName.required.$invalid">{{ $t("email_address_is_required") }}</span>
                  ...
                  <div class="w-full relative">
                    ...
                    <div    
                    class="absolute bottom-[10px] ltr:right-[14px] rtl:left-[14px] cursor-pointer hover:opacty-80"   v-if="!isPasswordVisible"    @click="togglePasswordVisibility"
                    >
