  ...
  <div class="max-w-[600px] relative h-[600px]">
      ...
      <div class="flex items-start justify-between flex-col w-full lg:p-0 p-3">
        <div class="flex-1 lg:mx-[-5px] mx-auto">
          <img
            ...
            alt="Tamkin logo"
            class="w-[160px] h-[81.28px]"
          />
        </div>

        <div class="mx-auto text-center xl:w-auto ipad-max:w-full">
          <h1
            class="dark:text-whiteTamkin text-[20px] lg:text-[32px] mb-[3px]"
          ...
          <h3
            class="dark:text-whiteTamkin/90 text-[16px] lg:text-[20px]font-[500] text-darkGrey mb-[14px]"
            ...
            <div class="space-y-[23px] w-full flex flex-col items-center">
              <div class="w-full relative">
                ...
                <label
                  ...
                  :class="[
                    v$.key.$error && v$.key.required.$invalid ? '!text-error' : '',
                  ]"
                >
                  {{ $t("key") }}*
                </label>
                ...
                <div
                  ...
                  v-if="v$.key.$error && v$.key.required.$invalid"
                >
    ...
    >
      <button
        ...
        v-if="!loading"
        :disabled="
          v$.password.$invalid || v$.password_confirm.$invalid || v$.key.$invalid
        "
      >
        {{ $t("updatePassword") }}
      </button>
