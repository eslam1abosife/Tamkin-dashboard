    ...
    <div class=" max-w-[600px] relative h-[600px]">
        ...
        <div class="flex items-start justify-between flex-col w-full lg:p-0 p-3 ">
            ...
            <div class="mx-auto text-center   xl:w-auto ipad-max:w-full">
              ...
              <h1 class="text-[26px] lg:text-[32px] mb-[6px]" style="line-height: 48px;">{{ $t("newPassprom") }}</h1>
              ...
              <div class="space-y-[23px] w-full">
                ...
                <div class="space-y-[23px] w-full flex flex-col items-center ">
                  ...
                  <div class="w-full relative">
                    ...
                    <div    
                    class="absolute bottom-[12px] ltr:right-[14px] rtl:left-[14px] cursor-pointer hover:opacty-80"   v-if="!isPasswordVisible"    @click="togglePasswordVisibility"
                    >
                    ...
                    <div    
                    class="absolute bottom-[12px] ltr:right-[14px] rtl:left-[14px] cursor-pointer hover:opacty-80"   v-else    @click="togglePasswordVisibility"
                    >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                  ...
                  <div class="w-full relative">
                    <input :type="ConfirmpasswordFieldType" placeholder="{{ $t('confirm_password') }}"  id="password_confirm" class="input_floating_label peer" 
                ...
                ,]"
                    ...
                    <div    
                    class="absolute bottom-[12px] ltr:right-[14px] rtl:left-[14px] cursor-pointer hover:opacty-80"   v-if="!isconfirmPasswordVisible"    @click="toggleConfirmPasswordVisibility"
                    >
                        <svg     xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    ...
                    <div    
                    class="absolute bottom-[12px] ltr:right-[14px] rtl:left-[14px] cursor-pointer hover:opacty-80"   v-else    @click="toggleConfirmPasswordVisibility"
                    >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                      </svg>
           ...
           <!-- Login button -->
           <div class="absolute top-[570px] inset-0  lg:p-0 p-3">
            <button class="btn-grad-action"  :disabled="v$.password.$invalid ||  v$.password_confirm.$invalid" >{{$t('updatePassword')}}</button>
          </div>
 </div>
  </template>
