...
<template>
    ...
    <div class="">
        ...
        <div class="pt-[6px] max-w-[580px] w-full text-center flex flex-col items-center justify-evenly mx-auto">
            ...
            <h3 class="text-[15px] lg:text-[20px] font-[600] text-secondary_text">{{$t('new_to_tamkin')}} <a href="" class="text-tamkin underline">{{$t('get_started')}}</a></h3>
            ...
            <div class="relative flex  items-center  mx-auto mt-[24px]">
                ...
                <span class="flex-shrink mx-4 text-secondary_text text-[20px] font-[600] ">{{$t('or')}}</span>
                <div class="flex-grow border-t border-darkGrey"></div>
            </div>
           ...
           <div class="space-y-[24px] mt-[24px] w-full">
            <div class="w-full relative">
                ...
                />
                <label for="email" class="floating_label">{{$t('email')}}*</label>
                <div
            ...
            <div class="w-full relative">
                ...
                />
                <label for="password" class="floating_label">{{$t('password')}}*</label>
                <div
                class="w-full lg:w-4/6 mt-2"
                v-if="
                  (v$.password.$error && v$.password.required.$invalid)
          ...
          <div class="flex flex-row items-center justify-between p-3">
            <div class="">
                ...
                <label for="remember_me" class="px-[8px]">{{$t('remember_me')}}</label>
            </div>
            <div class=" ">
                <nuxt-link to="/auth/reset-password" class="text-[15px] font-[500] underline text-tamkin">{{$t('forgot_password')}}</nuxt-link>
            </div>
          </div>
           ...
           <div class="pt-[40px] ">
            <button class="btn-grad-action" @click="loginUser"  v-if="!loading"
            :disabled="v$.email.$invalid || v$.password.$invalid || loading">{{$t('login')}}</button>
