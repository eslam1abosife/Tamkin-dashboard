...
">
            ...
            <div class="ml-auto absolute right-0 top-[119px]">
                <Vue3Lottie :animationData="mysiteAnimation" class="absolute left-[25%] top-[125px]" :height="32" :width="39"
                 />
        ...
        <section class="w-full mx-auto mt-[24px]">
                    ...
                    <div class="inline-block min-w-full align-middle md:px-6 lg:px-8">
                        <div class="rounded-[10px] bg-white">
                            <div class="flex items-center justify-center lg:justify-between flex-row">
                                <div class="flex items-center space-x-[16px] mx-[24px]">
                                ...
                                <div class="flex items-center justify-between lg:p-[16px]">
                                    <div class="p-[16px] search_input w-[289px]">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 pb-[35px]" v-if="currentTab === 'saved'">
                                <thead>
                                    <tr>
                                        <th
                                            class="py-3.5 px-4 text-left text-[14px] font-[400] leading-[21px] text-darkGrey">
                                            Sites URL
                                        </th>
                                        <th
                                            class="py-3.5 px-4 text-left text-[14px] font-[400] leading-[21px] text-darkGrey">
                                        ...
                                        <th
                                            class="flex items-center justify-center text-left text-[14px] font-[400] leading-[21px] text-darkGrey">
                                            <div>Status</div>
                                            <div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        <td
                                            class="flex items-center justify-evenly px-4 py-4 lg:mt-0 mt-[20px] space-x-4 text-[14px] font-[400] text-darkGrey">
                                            <img src="/assets/imgs/icons/avatar_table.svg" alt=""
                                                class="lg:block hidden lg:h-full h-[30px] lg:mt-0" />
                        ...
                        ">
                                        ...
                                        <td class="px-4 py-4 text-[14px] leading-[21px] font-[400] text-darkGrey">
                                            Monthly
                                        </td>
                                        ...
                                        <td class="px-4 py-4 text-darkGrey text-center">
                                            <div style="
                          background: linear-gradient(
                            180deg,
                            #2dada3 0%,
                                        ...
                                        <td class="px-4 py-4 text-[14px] font-[400] text-darkGrey">
                                            <div class="flex items-center space-x-[15px]">
                                                <div class="hover:opacity-50">
                                                    <img src="/assets/imgs/icons/installed.svg" alt="" />
                                                </div>
                                                <div>
                        ...
                        ">
                                        ...
                                        <td class="px-4 py-4 text-[14px] font-[400] text-darkGrey">
                                            <div class="flex items-center space-x-[15px]">
                                                <div class="hover:opacity-50">
                                                    <img src="/assets/imgs/icons/install.svg" alt="" />
                                                </div>
                                                <div>
                                                    <svg width="18" height="17" viewBox="0 0 18 17"
                                                        class="text-[#8C8C8C] hover:text-[#E80902] cursor-pointer"
                            ...
                            <table class="min-w-full divide-y divide-gray-200 pb-[35px]"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th
                                            class="py-3 px-4 text-right text-[15px] leading-[22.5px] font-[500] text-darkGrey flex items-center justify-end space-x-[10px]">
                                            <div class="">Restore All</div>
                                            <div>
                                                <input type="checkbox" id="checkbox" class="peer sr-only m-auto"
                                                    v-model="checkAll" />
                                                <label for="checkbox"
                                                    class="relative block border-[1px] w-[18px] h-[18px] border-lightGrey bg-whiteTamkin rounded-[4px] peer-checked:border-0 peer-checked:bg-gradient-checked">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="dSite in deletedSites" :key="dSite.id">
                                        <td
                                            class="flex items-center justify-start px-4 py-4 lg:mt-0 mt-[20px] space-x-[10px] text-[14px] font-[400] text-darkGrey">
                                            <div>
            ...
            " class="px-3 py-1 rounded-md text-white focus:outline-none">
                    ...
                    <button
                        class="px-3 py-1 rounded-md bg-transparent text-darkGrey hover:bg-[#A7A7A7] hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                        20
                    </button>
                </div>
                <div class="flex items-center space-x-2">
                    ...
                    <button
                        class="px-3 py-1 rounded-md bg-transparent text-darkGrey hover:bg-[#A7A7A7] hover:text-white focus:outline-none">
                        1
                    </button>
                    <button style="
              background: linear-gradient(180deg, #2dada3 0%, #71dad2 100%);
            " class="px-3 py-1 rounded-md hover:bg-[#A7A7A7] text-white focus:outline-none">
                    ...
                    <button
                        class="px-3 py-1 rounded-md bg-transparent text-darkGrey hover:text-white hover:bg-[#A7A7A7]">
                        &gt;
                    </button>
                </div>
            </div>
