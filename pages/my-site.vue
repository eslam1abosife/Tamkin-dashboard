...
<template>
  <div class="mt-[23px]">
    ...
    <div class="mt-[18px] flex items-center justify-start space-x-[36px]">
      <div>
        <button
          class="btn-dashboard-normal normal_hover text-[16px] leading-[24px] font-[500]"
        >
          Add New Site
        </button>
      </div>
      <div>
        <button
          class="btn_bordered_dashboard normal_hover bg-white text-[16px] leading-[24px] font-[500]"
        >
          Upgrade Plans
        </button>
      </div>
    ...
    >
      <div
        class="flex items-center lg:flex-row flex-col justify-start px-[16px] py-[23px] w-full bg-white lg:w-[73%] 2xl:w-[75%] h-[200px] lg:h-[129px] rounded-[10px]"
          ...
          <div class="flex flex-col lg:flex-row items-center justify-between">
            <div class="flex items-center justify-start space-x-[8px]">
              ...
              <div class="flex items-center space-x-[16px]">
                ...
                <div>
                  <h2
                    class="font-[600] text-[16px] leading-[24px] text-darkGrey underline"
                  >
                    Tamkin.App
                  </h2>
                </div>
      ...
      <div class="ml-auto absolute right-0 top-[119px]">
        ...
        />
        <img
          src="/assets/imgs/man_mysite.svg "
          class="h-[300px] lg:block hidden"
          alt=""
        />
      </div>
    </div>
    ...
    <section class="w-full mx-auto mt-[24px]">
            ...
            style="box-shadow: 0px 4px 24px 8px #51459f1a">              <div
              ...
              >
                <div class="flex items-center space-x-[16px] pl-[16px]">
                  <div
                    class="hover:bg-tamkinLight px-[1px] pt-[16px] cursor-pointer"
                  >
                    <div
                      ...
                      class="text-[14px] px-[4px] font-[600] pb-[16px] text-[#021328]"
                  ...
                  >
                    <div
                      ...
                      class="text-[14px] px-[4px] font-[400] pb-[16px] text-[#021328]"
                      style="line-height: 21px"
                    >
                      Deleted Sites (4)
                    </div>
              ...
              >
                <thead>
                  <tr class="h-[50px]">
                    ...
                    <th
                      class=" text-left text-[14px] font-[400] leading-[21px] text-darkGrey"
                    >
                      Billing
                    </th>
                    <th
                    ...
                    <th
                    class="flex items-center justify-start space-x-[6px] text-left text-[14px] font-[400] leading-[21px]
                     text-darkGrey"
                    >
                      <div>Status</div>
                      <div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr class="h-[50px]">
                    ...
                    <td
                      class="text-[14px] leading-[21px] font-[400] text-darkGrey"
                    >
                      Monthly
                    </td>
                  ...
                  <tr class="bg-[#FAEBEB] h-[50px]">
                    ...
                    <td class=" text-darkGrey text-left">
                      <div
                        class="text-[14px] font-[600] leading-[21px] text-[#DE4134]"
                      >
                        Not installed
                      </div>
                    </td>
                  ...
                  <tr class="h-[50px]">
                    ...
                    >
                      ...
                      <div
                        ...
                        font-[500] leading-[15px] w-[47px] h-[23px] rounded-[17px] p-[10px]"
                        style="
                          background: linear-gradient(
                            180deg,
                            #2dada3 0%,
                  ...
                  <tr v-for="dSite in deletedSites" :key="dSite.id" class="h-[50px]">
                    ...
                    >
                      <div>
                        ...
                        />
                        <label
                          :for="`checkbox_` + dSite.id"
                          class="relative block border-[1px] w-[18px] h-[18px] 
                          border-lightGrey bg-whiteTamkin rounded-[4px] peer-checked:bg-gradient-checked peer-checked:border-0"
                        >
                          <svg
                            class="peer-checked:block absolute inset-0  w-4 h-4 text-white"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
      ...
      <div class="flex justify-between items-center py-[16px]">
        <div class="flex items-center space-x-2">
          ...
          <button
            class="px-3 py-1 rounded-md  text-white bg-darkGrey focus:outline-none focus:ring-2
