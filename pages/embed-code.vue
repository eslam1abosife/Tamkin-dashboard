...
">
          <div class="flex items-center  lg:flex-nowrap flex-wrap md:flex-nowrap
           justify-between mt-[30px] w-full  px-[15px] " style="padding: 30px, 16px, 20px, 15px">
            <button @click="showAdancedCode()" class="btn__icon__dashboard text-[14px] order-1 " style="
                ...
                <div class="ltr:pl-[16px] rtl:pr-[16px]">
                  <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="url(#paint0_linear_275_10607)" stroke-width="1.5" />
                    <path
                      ...
                      stroke="url(#paint1_linear_275_10607)" stroke-width="1.5" stroke-linecap="round" />
                    <defs>
                      <linearGradient id="paint0_linear_275_10607" x1="11" y1="1.5" x2="11" y2="19.5"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#2DADA3" />
                        <stop offset="1" stop-color="#71DAD2" />
                      </linearGradient>
                      <linearGradient id="paint1_linear_275_10607" x1="11" y1="5.5" x2="11" y2="19.5"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#2DADA3" />
                        <stop offset="1" stop-color="#71DAD2" />
                      </linearGradient>
