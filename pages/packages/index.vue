...
<template>
  <div class="w-full relative px-[40px]" v-if="!packagesStore.loadingData && packagesStore.currentType.title === 'Sign language'">
    ...
    <div class="grid grid-cols-1 w-full relative">
      ...
      <PackagesMediaPricing
        v-if="
         ( packagesStore.currentTabTitle === 'Media' || packagesStore.currentTabTitle === 'Documents' ||packagesStore.currentTabTitle === 'Images') 
  ...
  >
    ...
    <PackagesFaq v-if="!packagesStore.loadingData && packagesStore.currentType.title === 'Sign language'"/>

    <!-- FAQ END-->

  <PackagesContact v-if="!packagesStore.loadingData && packagesStore.currentType.title === 'Sign language'"/>
