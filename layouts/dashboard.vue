...
controlDeleteModal" />
    ...
    <div
      class="lg:relative flex items-center justify-start flex-col bg-[#FFFEFE] z-[100] border-t-0 border-b-0 border-r border-[1px] border-lightGrey" 

      :class="[
        sideBarOpenMobile
          ? 'fixed inset-0 z-[9999] w-full h-screen '
          : 'hidden lg:flex',
        sideBarOpen ? 'min-w-[300px]' : 'min-w-[100px]',
      ]">
      <div @click="toggleSidebar" :class="[
        !sideBarOpen
          ? ' rotate-180 lg:!top-[146px]'
          : 'top-[147px] rtl:lg:right-[95%] ltr:lg:left-[95%]',
      ]"
        ...
        <nav style="box-shadow: 0px 4px 24px 8px #51459f14"
          ...
          <div class="flex items-center lg:justify-end justify-center lg:ml-auto space-x-[24px] lg:space-x-[43px]">
            <div @click="showNotifiations = !showNotifiations" :class="[showNotifiations ? 'active_notification' : '']"
              class="cursor-pointer flex items-center justify-center border-[1px] border-[#EAEAEA] rounded-[8px]
               bg-[#FFFEFE] w-[40px] h-[40px]">
