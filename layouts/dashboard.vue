  ...
  <div class="relative min-h-screen   dark:!bg-p  " :class="[!navStoreRef.sideBarOpen ? 'flex' : 'flex']">
    ...
    <div class="flex items-start lg:flex-row flex-col md:justify-between lg:justify-between relative w-full">
      ...
      <div class="relative top-0 w-full">
        <nav style="box-shadow: 0px 4px 24px 8px #51459f14"
          ...
          <div class="flex ipad-max:w-[75%] items-center lg:space-x-0 space-x-[10px] lg:px-0 px-[20px] w-full"
            :class="[sideBarOpen ? 'lg:max-w-[78.5%]' : 'lg:max-w-[97%]']">
            <div class="flex items-center justify-between lg:hidden" @click="toggleSidebarMobile"
            ...
            <div class="flex items-center justify-end lg:ml-auto space-x-[14px] lg:space-x-[43px] w-full"
              ...
              <div @click="showNotifiations = !showNotifiations"
                ...
                <div class="relative stroke-current dark:text-whiteTamkin text-darkGrey">
                  <div :class="[showNotifiations ? 'hidden' : '']"
                    ...
                    <span class="ipad-max:text-[10px] text-[12px] font-[700] text-white"
                      style="line-height: 68px">5</span>
                  </div>
                  <svg width="18" height="18" viewBox="0 0 20 22" fill="none"
                    :class="[showNotifiations ? 'active_bell' : '']" class="ipad-max:h-[14px] ipad-max:w-[14px]"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
              ...
              <div class="lg:block hidden">
                <img v-if="userImg" :src="userImg"
                  class="ipad-max:w-[30px] ipad-max:h-[30px] w-[40px] h-[40px] rounded-full border" />
                <div v-else
    ...
    "></div>
          <div class="relative px-[15px]">
            <NavbarOverview v-if="isLinkActive('/overview') ||
    isLinkActive('/settings') ||
    isLinkActive('/addons') ||
    isLinkActive('/customize') ||
    isLinkActive('/addons') ||
