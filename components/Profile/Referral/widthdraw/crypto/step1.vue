...
<template>
  ...
  <div style="box-shadow: 1px 0px 20.5px 0px #71dad2bd" class="close_btn" @click="closeModal('crypto_step1')">
    <svg
      class="w-[12px] h-[12px]"
      width="14"
      height="13"
...
<div class="flex items-center justify-between w-full   ">
 ...
 :class="[v$.walletAddress.$error && v$.walletAddress.required.$invalid ? 'border-red-600 border-[1px] ' : 'custom-border-tamkin padding-override-1 rounded-input']">
  ...
  <div class="text-[12px] font-[500] leading-[18px] text-[#021328] mt-[16px]">
    Please ensure you enter the correct address on the Binance network. Using an incorrect network may result in the permanent loss of your funds
  </div>

       <div class="ipad-max:mt-[90px] mt-[90px] 2xl:mt-[118px] px-[20px] rtl:mr-auto ltr:ml-auto">
        <button class="btn-dashboard hover_tamkin"  @click="navigateTo('crypto_step1','referrals','crypto_step_2_e')">
          Continue
      </button>
      </div>
</div>
