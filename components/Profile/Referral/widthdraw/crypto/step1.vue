...
<template>
  <div v-if="isOpen('crypto_step1')"     class="fixed z-[9999] top-[50px] bg-white dark:bg-tamkinDarkPrimary rounded-[10px] p-[30px]  h-[513px] 
  w-[600px]"
  style="left: 50%; transform: translate(-50%, 0)">
    ...
    <div class="mx-auto max-h-[100%] w-full">
      ...
      <div class="w-full relative mt-[14px] rounded-[10px]  "
        ...
        <div class="w-full lg:w-4/6 " v-if="(v$.wallet.$error && v$.wallet.required.$invalid)">
          <p class="error_message">
            <span v-if="v$.wallet.$error && v$.wallet.required.$invalid">{{ $t("Wallet Address is required")
              }}</span>
      ...
      <div class="ipad-max:mt-[90px] mt-[90px] 2xl:mt-[118px] px-[20px] rtl:mr-auto ltr:ml-auto">
        <button class="btn-dashboard hover_tamkin" @click="gotoStep2" :disabled="isLoading || v$.$invalid || !withdrawStore.selectedCrypto">
