...
<template>
  ...
  >
    ...
    <div class="mx-auto max-h-[100%] w-full">
      ...
      <div
        class="h-auto py-[14px] px-[20px] my-[24px] w-full bg-gradient-to-r from-[#11D5C6]/20 to-[#82ABE2]/20 rounded-[10px] mt-[10px] flex flex-col sm:flex-row items-center justify-between"
      >
