        ...
        <div class="w-full relative">
          ...
          <div class="flex items-center justify-between w-full rtl:space-x-reverse space-x-[30px]">
            <div class="w-full relative">
              ...
              input_success: !v$.account_number.$error && !v$.account_number.$invalid,
            }" />
                <label for="account_number" class="floating_label !top-[12px]" :class="[
              (v$.account_number.$error && v$.account_number.required.$invalid)
                ? '!text-error'
                : '',
            ]">
                ...
                <div class="w-full lg:w-4/6 " v-if="(v$.account_number.$error && v$.account_number.required.$invalid)">
                  <p class="error_message">
                    <span v-if="v$.account_number.$error && v$.account_number.required.$invalid">{{ $t("Account Number is required")
                      }}</span>
              ...
              <div class="w-full  relative">
                <input type="text" placeholder="" id="iban" class="input_floating_label !top-[12px] peer  !h-[50px] w-full !h-[50px]"
                  v-model="v$.iban.$model" :class="{
              input_error:
                (v$.iban.$error && v$.iban.required.$invalid),
              input_success: !v$.iban.$error && !v$.iban.$invalid,
            }" />
                <label for="iban" class="floating_label !top-[12px]" :class="[
              (v$.iban.$error && v$.iban.required.$invalid)
                ? '!text-error'
                : '',
            ]">
                ...
                <div class="w-full lg:w-4/6 " v-if="(v$.iban.$error && v$.iban.required.$invalid)">
                  <p class="error_message">
                    <span v-if="v$.iban.$error && v$.iban.required.$invalid">{{ $t("IBAN is required")
                      }}</span>
          ...
          <div class="flex items-center justify-between w-full rtl:space-x-reverse space-x-[30px]">
            <div class="w-full relative">
              ...
              input_success: !v$.bic.$error && !v$.bic.$invalid,
                ...
                <label for="bic" class="floating_label !top-[12px]" :class="[
              (v$.bic.$error && v$.bic.required.$invalid)
                ? '!text-error'
                : '',
            ]">
