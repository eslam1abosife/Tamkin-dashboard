...
<template>
  <div class="flex flex-col h-full w-full p-4">
    ...
    <div class="flex-grow">
      ...
      <div class="space-y-[23px] w-full flex flex-col items-center mt-[20px]">
        ...
        <div class="relative w-full">
          ...
          <div class="password_eye" v-if="!isOldPassVisible" @click="toggleOldPassVisible">
            <!-- Eye icon SVG for hiding password -->
          </div>
    ...
    <div class="mt-auto ml-auto ">
      <!-- <button class="btn-dashboard hover_tamkin w-full" @click="updatePassword">Update Password</button> -->
