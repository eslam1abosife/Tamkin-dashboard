...
<template>
  ...
  >
    <div class="flex items-start justify-start w-full">
      <div class="flex items-center justify-start gap-4 w-full">
        <div class="relative">
          ...
          <img
            v-if="profileStore.company.agency_image"
          ...
          />
          <div
            v-else-if="!profileStore.company.agency_image && !profileStore.company.agency_name"
    ...
    >
      <div class="text-[11px] lg:text-[12px] font-[500] ipad-max:text-[10px]" >Active</div>
    </div>
    </div>
    </div>
  </div>
