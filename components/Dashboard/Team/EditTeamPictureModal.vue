...
<template>
  <div v-if="isOpen('editteampic')"
    ...
    <div v-bind="getRootProps()" style="
      ...
      <div v-else-if="currTeam.team_image && !isImageDeleted"
           class="upload-file-item">
    ...
    <div class="flex items-center justify-center space-x-[30px] mx-auto mt-[40px]">
      <button
          ...
          @click="removeFile"
          :class="!currTeam?.team_image && acceptedFilesRef.length === 0 && 'opacity-40'"
      ...
      <button
          :disabled="(acceptedFilesRef.length == 0 && !isImageDeleted) || uploadLoading || deleteLoading"
