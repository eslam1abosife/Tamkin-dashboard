...
<template>
  ...
  <h1 class="text-[20px] lg:text-[24px] leading-[36px] font-[600] text-darkGrey ltr:ml-[20px] rtl:mr-[20px] lg:mt-0 mt-[60px]">
        Payment Process
    </h1>
    </div>
    <div
    ...
    <div>
        <img src="/assets/imgs/payment_methods/declined.svg" class="w-[60px] h-[60px]" alt="">
    </div>
