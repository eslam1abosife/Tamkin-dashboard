       ...
       <div class="bg-[#EFF1F6] rounded-[10px] h-[50px] w-full p-[6px]  animate-pulse">
        ...
        bg-[#EFF1F6] rounded-[10px] h-[50px] p-[10px]">
            ...
            <div class="flex items-center justify-start w-full space-x-[14px]">
              ...
              <div >
                <svg :class="[isMenuOpen ? 'rotate-90':'rtl:rotate-180 ltr:rotate-0']" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
"
  ...
  <div @click="$router.push(localePath('/profile'))" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
      <div>
        
        <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0.5 13.4999V12.7777C0.5 10.3844 2.34682 8.44434 4.625 8.44434H7.375C9.65317 8.44434 11.5 10.3844 11.5 12.7777V13.4999" stroke="#585B5B" stroke-linecap="round"/>
          <path d="M6 6.27778C4.48122 6.27778 3.25 4.98438 3.25 3.38889C3.25 1.7934 4.48122 0.5 6 0.5C7.51876 0.5 8.75 1.7934 8.75 3.38889C8.75 4.98438 7.51876 6.27778 6 6.27778Z" stroke="#585B5B" stroke-linecap="round"/>
          </svg>
...
<hr class="bg-[#EAEAEA] w-full !p-0">
  <div @click="helpWindow" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
      <div>
        <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.5 13.5C9.53757 13.5 12 10.5899 12 7C12 3.41015 9.53757 0.5 6.5 0.5C3.46243 0.5 1 3.41015 1 7C1 10.5899 3.46243 13.5 6.5 13.5Z" stroke="#585B5B"/>
          <path d="M6.50078 9.60039C7.71581 9.60039 8.70078 8.43633 8.70078 7.00039C8.70078 5.56445 7.71581 4.40039 6.50078 4.40039C5.28575 4.40039 4.30078 5.56445 4.30078 7.00039C4.30078 8.43633 5.28575 9.60039 6.50078 9.60039Z" stroke="#585B5B"/>
          <path d="M8.14844 5.0502L10.3484 2.4502M2.64844 11.5502L4.84844 8.9502M4.84844 5.0502L2.64844 2.4502M10.3484 11.5502L8.14844 8.9502" stroke="#585B5B"/>
          </svg>
  ...
  <div @click="logout" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
      <div>
        <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M4.16797 7H11.5013M11.5013 7L9.66797 4.5625M11.5013 7L9.66797 9.4375" stroke="#585B5B" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
...
<div class="text-[10px] leading-[12px] font-[500] text-black underline">
  <a href="https://tamkin.app/privacy-policy?_lang=en" target="_blank" class="text-tamkin underline" @click.stop>{{$t('Privacy Policy')}} </a>
</div>
<div class="text-[10px] leading-[12px] font-[500] text-black ">•</div>
<div class="text-[10px] leading-[12px] font-[500] text-black underline">
  <a href="https://tamkin.app/terms?_lang=en" target="_blank" class="text-tamkin underline" @click.stop> {{$t('Terms of Service')}}</a>
</div>
  </div>
        </div>
