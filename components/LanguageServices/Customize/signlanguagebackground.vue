...
<template>
  ...
  >
    ...
    >
      ...
      <div
        @click.stop="collapseStore.collapseMenu('sign_background')"
        v-on-click-outside="() => collapseStore.removeMenu('sign_background')"
        :class="[
      ...
      >
        ...
        <div
          v-if="collapseStore.menus.includes('sign_background')"
    ...
    >
      ...
      >
        <div
          v-if="
            customizeStore.backgroundItems.tamkin_option_item_values.find(
              (el:any) => el.value == 'option1'
            ).active == 1
          "
