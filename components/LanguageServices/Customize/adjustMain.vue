...
const {AdjustMainMenuCardsCustomize,initialCardsOrderCustomize} = storeToRefs(customizeStore)
...
<template>
  <div
    class=" mt-[30px] flex flex-col items-center justify-center   w-full relative" >
    <!-- <MessagesLockedFeature/> -->
  <div 
  

  class=" bg-white  dark:bg-tamkinDarkPrimary rounded-[10px] w-full px-[15px] shadow-md  -shadow-y-[1px] relative" :class="[collapseStore.collapses.includes('adjust_main_menu_customize_sign_card') ? 'pb-[24px]' :'pb-[10px]']" >
        <div class="flex items-center justify-start  pt-[21px]">
          <div>
            ...
            Manage Your Sign Language Settings for a Customized and Accessible Communication Experience        </p>
          </div>

          <div
            @click.stop="collapseStore.collapseMenu('adjust_main_menu_customize_sign')"
            v-on-click-outside="() => collapseStore.removeMenu('adjust_main_menu_customize_sign')"

            :class="[
              collapseStore.menus.includes('adjust_main_menu_customize_sign') ? 'active_notification !text-darkGrey' : '',
            ]"
          ...
          >
            <svg
              ...
              :class="[
                collapseStore.menus.includes('adjust_main_menu_customize_sign')
? 'stroke-current !text-white !fill-white' : 'dark:text-white',
            ...
            <div
              v-if="collapseStore.menus.includes('adjust_main_menu_customize_sign')"
          ...
          >
            ...
            <div class="text_mini">
              ...
              <div
                class="mini_wrap"
                @click="collapseStore.collapseCard('adjust_main_menu_customize_sign_card')"
              >
                <div>
        ...
        <div
          ...
          v-if="!collapseStore.collapses.includes('adjust_main_menu_customize_sign_card')"
        >
        <draggable
           
        v-model="AdjustMainMenuCardsCustomize"
        @change="customizeStore.onDragChange('AdjustMainMenuCardsCustomize', 'initialCardsOrderCustomize')"
        @start="customizeStore.onDragStart('initialCardsOrderCustomize')"
        @end="customizeStore.onDragEnd('AdjustMainMenuCardsCustomize', 'initialCardsOrderCustomize')"
        item-key="name"
