...
<template>
  ...
  >
    ...
    >
      ...
      <div
        @click.stop="collapseStore.collapseMenu('sign_keyboard')"
        v-on-click-outside="() => collapseStore.removeMenu('sign_keyboard')"
        :class="[
      ...
      >
        ...
        <div
          v-if="collapseStore.menus.includes('sign_keyboard')"
    ...
    >
      ...
      <!-- <TranslateSelectInput
        ...
        :enableSearch="false"
        placeholderinput="Auto-detect speakers"
        class="mt-[15px] !w-1/4"
        :list="projectNameArr"
        nameKey="name"
        idField="id"
