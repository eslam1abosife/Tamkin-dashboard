...
<template>
    <div
        ...
        <div class="flex items-center justify-start ltr:ml-[15px] rtl:mr-[15px] pt-[24px]">
            <div>
                <h1 class="text-[14px] lg:text-[18px] font-[500] leading-[30px] dark:text-whiteTamkin">Sign language
                    Background</h1>
            ...
            <div @click.stop="collapseStore.collapseMenu('sign_keyboard')"
                v-on-click-outside="() => collapseStore.removeMenu('sign_keyboard')" :class="[
                    collapseStore.menus.includes('sign_keyboard')
                ...
                <div v-if="collapseStore.menus.includes('sign_keyboard')" style="box-shadow: 0px 2px 6px 0px #00000040"
                    ...
                    <div class="mini_wrap" @click="collapseStore.collapseCard('sign_keyboard_card')">
                        <div>
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.7754 10.937L18.4995 7" class="dark:!stroke-white stroke-darkGrey"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M14.7207 7H18.5V10.1496" class="dark:!stroke-white stroke-darkGrey"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M11.2241 13.063L6.5 17" class="dark:!stroke-white stroke-darkGrey"
                                    stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div class="arrow">
                        <svg width="16" class="" height="16" viewBox="0 0 16 16" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <defs>
        ...
        <div class="px-[15px] mt-[32px]" v-if="!collapseStore.collapses.includes('sign_keyboard_card')">
            ...
            <div
                ...
                <div class="flex items-center justify-start rtl:space-x-reverse space-x-[13px] w-full">
                    <img src="/assets/imgs/signlanguageservices/keyboard_toggle.png" class="h-[28px] w-[28px]" />
                    <div class="flex flex-col items-start justify-center w-full">
                        <div class="text-[#23262F] dark:text-whiteTamkin font-[500] text-[14px] leading-[16.39px]">
                            <span>Keyboard</span>
                        </div>
                        <div class="text-[#585B5B] dark:text-whiteTamkin font-[500] text-[10px]
                  
                  lg:w-full w-40 truncate lg:text-[12px] leading-[13.66px] mt-[8px]">
                            <span>
                                Manage your sign language tools and personalize them to enhance your communication
                                experience. </span>
                        </div>
                    </div>
                    <div class="ml-auto">
                        <label for="keyboard" class="toggle_wrap">
                            <input type="checkbox" id="keyboard" class="sr-only" :checked="isChecked('keyboard_checkbox')"
                                @change="toggleCheckbox('keyboard_checkbox')" />
                            <div class="toggle_parent" :class="[
                                isChecked('keyboard_checkbox')
                                    ? 'active'
                                    : 'in_active',
                            ]">
                                <div class="toggle_inner" :class="{ 'active': isChecked('keyboard_checkbox') }">
                                    <img v-if="isChecked('keyboard_checkbox')" src="/assets/imgs/translatevideo/sign_active.svg"
                                        class="w-[28px] h-[28px]" />
            ...
            <TranslateSelectInput v-if="isChecked('keyboard_checkbox')" @getCurrentSelectedItem="handleSelectedItemProjectName" :enableSearch="false"
                placeholderinput="Auto-detect speakers" class="mt-[15px] !w-1/4" :list="projectNameArr" nameKey="name" idField="id" />
