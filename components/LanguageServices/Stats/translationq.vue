...
<template>
  ...
  >
    <div class="flex items-center justify-start ">
      <div class="pt-[24px]">
        <h1 class="text-[14px] lg:text-[18px] font-[500] leading-[30px] dark:text-whiteTamkin">Translation quality</h1>
...
? 'stroke-current !text-white !fill-white' : 'dark:text-white',
    ...
    <div
      class="w-full mt-[24px] mx-auto  dark:bg-tamkinDarkPrimary rounded-lg lg:overflow-x-hidden overflow-x-auto"
 ...
 <div class="flex items-center justify-between w-full ">
    <div class="flex flex-col items-start justify-center w-full ">
       ...
       <div>
        <Circularprogressbar svg-class="w-[200px] h-[200px]"/>
       </div>
