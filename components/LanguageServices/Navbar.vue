...
<template>
 ...
 lg:overflow-x-hidden overflow-x-auto  left-0 w-full  lg:mx-auto h-[43px] rounded-[22px] bg-white dark:bg-tamkinDarkPrimary
  ...
  >
    ...
    <nuxt-link
      :class="isLinkActive('/sign-language/overview') ? 'active_subNavb' : 'sub_menu_item'"
    ...
    <nuxt-link
      :class="isLinkActive('/sign-language/addons') ? 'active_subNavb' : 'sub_menu_item'"
    ...
    <nuxt-link
      :class="isLinkActive('/sign-language/statistics') ? 'active_subNavb' : 'sub_menu_item'"
      class="relative z-[20] w-full lg:px-0 px-2 lg:w-[96px] h-[31px] flex items-center justify-center"
    ...
    <nuxt-link
      :class="isLinkActive('/sign-language/customize') ? 'active_subNavb' : 'sub_menu_item'"
      class="relative z-[20] w-full lg:px-0 px-2 lg:w-[96px] h-[31px] flex items-center justify-center"
    ...
    <nuxt-link
      :class="isLinkActive('/sign-language/settings') ? 'active_subNavb' : 'sub_menu_item'"
