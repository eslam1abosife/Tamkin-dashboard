        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  ...
                  <div class="flex items-start flex-col justify-center space-y-[-4px]">
                    ...
                    >
                      Pay Via {{ marketStore.selectedCrypto.code }} and get
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    :id="'radio_' + marketStore.selectedCrypto.name"
                    type="radio"
                    name="radio"
                    class="hidden"
                    :value="marketStore.selectedCrypto.name"
                    @click=""
                    checked
                    number
                  />
                    ...
                    <ul>
                      ...
                      >
                        ...
                        <span
                          ...
                          >{{ cryptoMethod.title }} - {{cryptoMethod.network }}
                        </span>
            ...
            >
              ...
              >
                By Choosing this crypto Currency that equal
                {{
                  convertUsdToCrypto(
                  ...
                  >
                    ...
                    >
                      ...
                      <!-- <span class="text-black font-[500] dark:text-whiteTamkin">
                            {{convertUsdToCryptos(marketStore.cartTotal,cryptostore.rates)}} {{selectedCrypto.title}}</span> -->
                      {{
                        convertUsdToCrypto(
                          marketStore.cartTotal,
                          cryptostore.rates,
            ...
            >
              ...
              <div
                ...
                class="!mr-auto px-[20px] !-mt-4 text-[12px] text-red-500"
              >
