...
const stripeElementReadyEV = () => {
  ...
  console.log("gg man readyt");
};

const completedStripe = (event) => {
  console.log(event);
  if (event.complete) {
    //  alert('completed')
...
<template>
  ...
  >
    <div style="box-shadow: 1px 0px 20.5px 0px #71dad2bd" class="close_btn_payment !cursor-pointer z-[999]
     dark:bg-tamkinDarkPrimary dark:text-whiteTamkin !top-[23px]" @click="closeModal('cardModal_market_step2')">
      <svg
        class="w-[12px] h-[12px]"
        width="14"
        height="13"
      ...
      <div class="w-full h-full">
        ...
        "
          ...
          <h1 class="text-[16px] lg:text-[18px] leading-[36px] font-[600] text-darkGrey dark:text-whiteTamkin ml-[20px] lg:mt-0 mt-[60px]">
            ...
            <div id="payment_page" tabindex="-1"></div>
            ...
            <button
              ...
              class="btn-primary-lg mt-4 mr-auto"
            >
              الدفع
            </button>
