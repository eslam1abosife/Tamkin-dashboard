  ...
  >
    ...
    <div class="w-full h-full pb-[50px]">
      ...
      >
        {{ $t("My Cart") }}
        {{
          marketStore.cartItems.length === 0 ? "" : `(${marketStore.cartItems.length})`
        }}
      </h1>
      <div
      ...
      >
        ...
        >
            ...
            >
              ...
              <div class="flex items-end flex-col justify-start space-y-[44px]">
                ...
                <p class="text-[#021328] text-[14px] font-[500] dark:text-whiteTamkin">
                  {{ $t('Price') }} <span class="px-1">${{ cartItem.cost }}</span>
                </p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div class="mt-8 flex justify-end rtl:space-x-reverse space-x-[20px] py-3">
              <button class="btn_bordered_dashboard">{{$t('Cancel')}}</button>
              <button
        ...
        <div class="flex items-center justify-center flex-col w-full h-full" v-else>
          ...
          >
            {{ $t("Your Cart is empty when you add products , they will appear here") }}
          </div>
        </div>
      </div>
    </div>
