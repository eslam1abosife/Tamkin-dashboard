...
<template>
  ...
  >
    ...
    <div class="market_card_char order-1" v-for="char in marketStore.tops" :key="char.id" :class="[char.purchased ? '!bg-selected' : '']" >
      <div
        class="w-[144px] h-full bg-[#FAFAFA] flex items-center justify-center rounded-[10px] relative "
      >
        ...
        <div class="mt-[30px]">
          <img :src="char.img" class="w-[78px] h-[78px]  " alt="" />
        </div>
      </div>
      ...
      <div class="flex flex-col justify-between h-full p-2">
        ...
        <div
          ...
          class="flex flex-col items-start justify-start mt-1"
        >
          <div
            class="w-[45px] h-[16px] bg-gradient-to-r
             from-[#FFD97E] via-[#FEE772] to-[#FFF1AD] rounded-[3px] font-[500] text-darkGrey text-[10px] flex items-center justify-center mb-2"
