...
return   navigateTo('buy_extra__service', "internalMediaservices", "buy_extra__service");
};
</script>
  ...
  >
    ...
    <div class="w-full h-screen">
      ...
      >
       ...
       <div class="w-full  mt-[32px]" v-if="!loadingDataModal">
        <h1 class="font-[500] text-[16px] leading-[30px] ">Buy more Minutes or Words</h1>
        <div class="mt-[16px] text-[14px] leading-[24px] text-darkborder">
            Increase your word and minutes count for translation services by purchasing additional credits now.
        </div>
       <MySiteExtrapricing/>
       </div>
  
       <div v-if="loadingDataModal" class="w-full mt-[64px] space-y-[32px]">
        <div v-for="t in 3" class="h-[383px] w-full  rounded-[10px] bg-gray-200 animate-pulse">
