    ...
    <div class="w-full h-full">
      <div class="flex flex-col items-start justify-center w-full">
        <div class="flex items-center justify-center">
          <div v-if="!urlPayment" @click="navigateTo('cardModal_mysite', 'mysite', 'payment_methods_mysite')"
              ...
              <div
                ...
                <div class="lg:py-[17px] search_input w-full lg:w-3/4 mt-[24px]">
                  ...
                  <div class="absolute top-[-8px] lg:top-[8px] rtl:right-[29px] ltr:left-[29px] p-[16px] 
                    flex items-center justify-evenly rtl:space-x-reverse space-x-[10px]" v-if="mysiteStore.validPromo">
