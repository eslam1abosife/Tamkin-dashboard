...
<div class="flex flex-col items-center justify-center w-full">
    <div  class="flex items-center  lg:flex-nowrap flex-wrap md:flex-nowrap justify-between mt-[30px] w-full  px-[15px] " style="padding: 30px, 16px, 20px, 15px">
      ...
      <div @click="copyCode" class="cursor-pointer lg:order-3  order-2 ipad-max:text-[12px] border-[2px] rounded-lg border-transparent bg-gradient-to-r from-[#2DADA3] to-[#71DAD2] group">
        <div
            class="bg-white dark:bg-tamkinDarkPrimary dark:text-white rounded-md flex items-center justify-center">
          <div class="ltr:pl-[16px] rtl:pr-[16px]">
...
function showAdvancedCode() {
  if (!advancedCode.value) {
    ...
    currentCode.value = detailedCode || `detailed Code not found`;
  } else {
    code.value = true;
