...
<template>
  ...
  >
    <div class="h-[200px] flex items-center justify-between w-full ">
      <div class="flex flex-col items-start justify-center px-[15px]">
        ...
        <div
        class=" h-[35px] flex items-center justify-start space-x-[50px]  "
        >
          <div class="flex items-center justify-start space-x-[10px] ">
            <div>
              <img
                src="/assets/imgs/translatevideo/words_icon.png"
                class="w-[25px] h-[25px] object-cover object-center block m-0 p-0"
                alt=""
              />
            </div>
      ...
      <div class="lg:flex hidden  items-center">
        ...
        <div class="w-full h-full relative">
          <div class="absolute bottom-4 right-0 mr-[15px]">
        ...
        <div class="flex flex-col items-start justify-center px-[15px]">
          ...
          >
            ...
            <div class="flex items-center justify-start space-x-[10px] ">
              ...
              <div class="text-[12px] lg:text-[14px] font-[700] text-[#3C3F49]">50 / 50 <span class="font-[500]"> Minutes</span></div>
            </div>
          </div>

          <button
            @click="changePlan('freetrial_expired')"
            class="btn-dashboard hover_tamkin mt-[8px] w-[158px] "
          >
            Upgrade now
          </button>
    ...
    <div
      ...
      class="w-full rounded-[10px] flex flex-col items-start justify-center space-y-[16px]"
      style="
        background: linear-gradient(
          90deg,
          rgba(212, 177, 248, 0.66) 3%,
          rgba(161, 206, 203, 0.66) 26.17%,
          rgba(245, 201, 197, 0.66) 52.17%,
          rgba(113, 218, 210, 0.66) 78.17%,
          rgba(165, 214, 242, 0.66) 100%
        );
      "
    >
      <div class="h-[200px] flex items-center justify-between w-full">
        <div
          class="flex flex-col items-start justify-center px-[15px]  lg:w-3/4"
        >
          <div class="flex items-center space-x-[10px]">
            <div>
              <img
          ...
          <div class="text-[12px] lg:text-[14px] font-[400] text-[#021328] leading-[20px] lg:leading-[27px]  lg:flex-shrink ipad-max:w-full  w-full lg:w-3/4">
            Your available words and minutes have been used up. Please purchase a new
            package or add more words and minutes to continue using the service
          </div>
        ...
        >
          ...
          <button
            @click="changePlan('pro_out_credit')"
            class="btn-dashboard hover_tamkin mt-[8px] !w-[158px] "
          >
        Upgrade Now
          </button>
        ...
        <div class="lg:flex hidden items-center relative  ">
          <div class="absolute right-[160px] w-[218px] h-[240px]">
            <img
              src="/assets/imgs/translatevideo/plan_vector.svg"
              class="w-[218px] h-[240px]"
              alt=""
    ...
    <div
      ...
      class="w-full rounded-[10px] flex flex-col items-start justify-center "
      style="
        background: linear-gradient(
          90deg,
          rgba(212, 177, 248, 0.66) 3%,
...
>
  <div class="h-[200px] flex items-center justify-between w-full">
    ...
    >
      ...
      <div class="text-[12px] lg:text-[14px] font-[400] text-[#021328] leading-[20px] lg:leading-[27px]  
      lg:flex-shrink ipad-max:w-full  w-full lg:w-3/4">
...
class="w-full rounded-[10px] flex flex-col items-start justify-center space-y-[24px]"
style="
  background: linear-gradient(
    90deg,
    rgba(212, 177, 248, 0.66) 3%,
...
<div class="h-[200px] flex items-center justify-between w-full">
  <div
    class="flex flex-col items-start justify-center px-[15px] space-y-[10px]  lg:w-3/4"
  >
    <div class="flex items-center space-x-[10px]">
      <div>
        <img
    ...
    <div class="text-[12px] lg:text-[14px] font-[400] text-[#021328] leading-[20px] lg:leading-[27px]  lg:flex-shrink ipad-max:w-full  w-full lg:w-3/4">
      Your available words and minutes have been used up. Please purchase a new package or add more words and minutes to continue using the service    </div>
