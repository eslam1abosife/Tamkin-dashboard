<template>
  ...
  >
    ...
    >
      ...
      <div class="flex flex-col items-center justify-start w-full pb-[24px]">
        <div>
          <TranslateCircle />
        </div>
        <div
        ...
        >
          ...
          >
            <div class="flex items-center justify-center rtl:space-x-reverse space-x-[6px]">
              ...
              ></span>
              <span class="text-gray-500 text-[14px] dark:text-whiteTamkin">{{ $t('Used') }} </span>
            </div>
            <span class="block text-[14px]font-semibold dark:text-whiteTamkin/90">20</span>
          </div>
          <div
          ...
          >
            <div class="flex items-center justify-center rtl:space-x-reverse space-x-[6px]">
              ...
              ></span>
              <span class="text-gray-500 text-[14px] dark:text-whiteTamkin">{{$t('Remaining')}}</span>
            </div>
            <span class="block font-semibold text-[14px] dark:text-whiteTamkin/90">20</span>
          </div>
        </div>
        ...
        <div class="w-full">
          ...
          <div class="flex flex-col items-center justify-center w-full space-y-[6px]">
            <div class="flex items-center mt-[24px] w-full">
              <div
                class="w-1/4 text-[#3D3D3D] dark:text-whiteTamkin text-[13px] leading-[24px] font-[400] rtl:ml-auto ltr:mr-auto"
              >
                {{ $t('Internal Use') }}
              </div>
              <span class="text-[#A6A6A6] text-[13px]  rtl:mr-auto ltr:ml-auto dark:text-whiteTamkin/90"
                >280</span
              >
            </div>
    ...
    <div class="flex flex-col items-center justify-start w-full pb-[24px]">
      ...
      <div class="w-full">
        ...
        <div class="flex flex-col items-center justify-center w-full space-y-[6px]">
          <div class="flex items-center mt-[24px] w-full">
            <div
              class="w-1/4 text-[#3D3D3D] dark:text-whiteTamkin text-[13px] leading-[24px] font-[400]
               rtl:ml-auto ltr:mr-auto"
            >
              {{ $t('Internal Use') }}
            </div>
            <span class="text-[#A6A6A6] text-[13px]  rtl:mr-auto ltr:ml-auto dark:text-whiteTamkin/90"
