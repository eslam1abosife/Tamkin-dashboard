<template>
  <div
    class="bg-white rounded-[13px] flex items-center p-[24px] justify-evenly w-full mt-[16px] space-x-[19px]"
  >
    <div
      class="custom-border padding-override-1 w-full flex flex-col items-center px-[16px] justify-start"
    >
      <div class="flex items-center justify-between w-full pt-[24px]">
        <div class="text-[16px] font-[500] text-[#021328]">Words Balance</div>

        <button
          class="btn-dashboard hover:bg-white hover:!text-tamkin w-[158px] !h-[40px]"
        >
          Upgrade Now
        </button>
      </div>

      <div class="flex flex-col items-center justify-center w-full pb-[24px]">
        <TranslateCircle />
        <div
          class="flex rtl:space-x-reverse items-center justify-evenly w-full mt-[16px]"
        >
          <div
          ...
          >
            <div class="flex items-center justify-center space-x-[6px]">
              ...
              ></span>
              <span class="text-gray-500 dark:text-whiteTamkin">Your total minutes </span>
            </div>
          ...
          >
            <div class="flex items-center justify-center space-x-[6px]">
              ...
              ></span>
              <span class="text-gray-500 dark:text-whiteTamkin">Remaining</span>
            </div>
            <span class="block text-xl font-semibold dark:text-whiteTamkin/90">20</span>
          </div>
        </div>
    ...
    <div class="custom-border w-full flex flex-col items-center px-[16px] justify-start">
      <div class="flex items-center justify-between w-full pt-[24px]">
        <div class="text-[16px] font-[500] text-[#021328]">Minutes Balance</div>
