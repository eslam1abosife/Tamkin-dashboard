...
return  !v$.value.projectName.$error
})
</script>

<template>
  <div class="bg-selected dark:bg-p fixed z-[9999] top-[0] 
    rtl:lg:left-0 ltr:lg:right-0 rounded-[10px] p-[20px] lg:w-[600px] w-full h-full  overflow-y-auto">
    ...
    <div class="w-full h-screen  pb-[50px]">
      ...
      <div class="flex flex-col items-start justify-start  space-y-[16px] h-full px-[12px]  bg-white
        ...
        <div class="w-full flex flex-col items-center justify-center !p-0">
          ...
          <div class="flex items-center justify-evenly w-full space-x-[24px]">
