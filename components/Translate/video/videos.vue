   ...
   <div>
    <div class="grid grid-cols-1 lg:grid-cols-5 ipad-max:grid-cols-3 mt-[10px] ">
        ...
        <div class="relative w-full ">
            <div @click="changeDropMenu(1)"
            :class="[currentMenuDrop !== 1 ? '' : '!flex']"
            class="hidden group-hover:flex items-center justify-center bg-[#CBC7D2] dark:bg-darkSecondary w-[18px] h-[18px] absolute rounded-[3px] p-[2px] top-[6px] right-0 mr-[6px] cursor-pointer">
         ...
         class="text-darkGrey dark:text-whiteTamkin"
            ...
            space-y-[3px]  justify-center" v-if="currentMenuDrop === 1">
        ...
        <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey dark:text-whiteTamkin hover:bg-tamkinLight dark:hover:bg-tamkinDarkPrimary  rounded-[4px] p-1 w-full h-[18px]">
            ...
            <img src="/assets/imgs/translatevideo/vid_1.png" class="object-cover w-full h-[91px] rounded-[7px]"  alt="">
        </div>
        ...
        <div class="h-[140px]  flex flex-col items-start justify-start rounded-[7px] shadow-lg group hover:border-tamkin hover:border-[1px] cursor-pointer mx-1 mb-2">
            <div class="relative w-full ">
                <div @click="changeDropMenu(2)"
                :class="[currentMenuDrop !== 2 ? '' : '!flex']"
                class="hidden group-hover:flex items-center justify-center bg-[#CBC7D2] w-[18px] h-[18px] absolute rounded-[3px] p-[2px] top-[6px] right-0 mr-[6px] cursor-pointer">
             ...
             class="text-darkGrey"
                ...
                <div class=" bg-white h-[60px]  absolute right-0 mr-[6px] top-[26px] rounded-[4px] flex flex-col items-start 
                space-y-[3px]  justify-center" v-if="currentMenuDrop === 2">
            <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight bg-white p-1 w-full rounded-[4px] h-[18px]">
                Download
            </div>
            <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight  rounded-[4px] w-full p-1 h-[18px]">
                Rename
            </div>
            <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight  rounded-[4px] p-1 w-full h-[18px]">
                Delete
            </div>
                </div>
                <img src="/assets/imgs/translatevideo/vid_3.png" class="w-full h-[91px] rounded-[7px] object-cover" alt="">
            </div>
            <div class="text-[#141C24] dark:text-whiteTamkin font-[500] text-[12px] leading-[16px] mt-[10px] pl-[15px]">
                AAAAAAAAAAAA
            </div>
            ...
            <div class="h-[140px]  flex flex-col items-start justify-start rounded-[7px] shadow-lg group hover:border-tamkin hover:border-[1px] cursor-pointer mx-1 mb-2">
                <div class="relative w-full ">
                    <div @click="changeDropMenu(3)"
                    :class="[currentMenuDrop !== 3 ? '' : '!flex']"
                    class="hidden group-hover:flex items-center justify-center bg-[#CBC7D2] w-[18px] h-[18px] absolute rounded-[3px] p-[2px] top-[6px] right-0 mr-[6px] cursor-pointer">
                 ...
                 class="text-darkGrey"
                    ...
                    <div class=" bg-white h-[60px]  absolute right-0 mr-[6px] top-[26px] rounded-[4px] flex flex-col items-start 
                    space-y-[3px]  justify-center" v-if="currentMenuDrop === 3">
                <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight bg-white p-1 w-full rounded-[4px] h-[18px]">
                    Download
                </div>
                <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight  rounded-[4px] w-full p-1 h-[18px]">
                ...
                <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight  rounded-[4px] p-1 w-full h-[18px]">
                    ...
                    <img src="/assets/imgs/translatevideo/vid_4.png" class="w-full h-[91px] rounded-[7px] object-cover" alt="">
                </div>
                <div class="text-[#141C24] dark:text-whiteTamkin font-[500] text-[12px] leading-[16px] mt-[10px] pl-[15px]">
                    AAAAAAAAAAAA
                </div>
                ...
                <div class="h-[140px]  flex flex-col items-start justify-start rounded-[7px] shadow-lg group hover:border-tamkin hover:border-[1px] cursor-pointer mx-1 mb-2">
                    <div class="relative w-full ">
                        <div @click="changeDropMenu(4)"
                        :class="[currentMenuDrop !== 4 ? '' : '!flex']"
                        class="hidden group-hover:flex items-center justify-center bg-[#CBC7D2] w-[18px] h-[18px] absolute rounded-[3px] p-[2px] top-[6px] right-0 mr-[6px] cursor-pointer">
                     ...
                     class="text-darkGrey"
                        ...
                        <div class=" bg-white h-[60px]  absolute right-0 mr-[6px] top-[26px] rounded-[4px] flex flex-col items-start 
                        space-y-[3px]  justify-center" v-if="currentMenuDrop ===4">
                    <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight bg-white p-1 w-full rounded-[4px] h-[18px]">
                        Download
                    </div>
                    <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight  rounded-[4px] w-full p-1 h-[18px]">
                    ...
                    <div class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight  rounded-[4px] p-1 w-full h-[18px]">
                        ...
                        <img src="/assets/imgs/translatevideo/vid_5.png" class="w-full h-[91px] rounded-[7px] object-cover" alt="">
                    </div>
                    <div class="text-[#141C24] dark:text-whiteTamkin font-[500] text-[12px] leading-[16px] mt-[10px] pl-[15px]">
                        AAAAAAAAAAAA
                    </div>
