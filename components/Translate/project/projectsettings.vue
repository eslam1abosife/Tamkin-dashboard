...
<template>
    <div class="bg-white dark:bg-tamkinDarkPrimary flex-col items-start rounded-[13px] h-auto flex p-[15px] justify-start w-full mt-[24px]">
      ...
      <div class="flex flex-row items-start justify-between gap-4 w-full mt-[42px]">
        ...
        <LazyTranslateProjectModesSubtitles v-show="translateStore.currentMode === 'subtitles' && !bigpicMode" key="23242"/>

        
        
        <LazyTranslateProjectModesPlayer  key="2113" v-show="translateStore.currentMode === 'player' && !bigpicMode" @player-position="getPlayerPosition" />
