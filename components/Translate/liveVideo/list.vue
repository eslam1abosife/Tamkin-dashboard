...
<div class="text-[#141C24] font-[500] text-[12px] leading-[16px] mt-[10px] rtl:pr-[15px] ltr:pl-[15px]">
    Live 1
</div>
<div class="text-[#141C24] font-[500] text-[10px] leading-[16px] rtl:pr-[15px] ltr:pl-[15px]">
