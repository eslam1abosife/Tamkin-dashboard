...
<template>
<div>
    <TranslateModalsRename renameType="Audio"/>
    ...
    <div class="grid grid-cols-5 mt-[10px] ">
        ...
        <div class="h-[140px]  flex flex-col items-start justify-start rounded-[7px] shadow-lg group hover:border-tamkin
         hover:border-[1px] cursor-pointer mx-1 mb-1">
        ...
        <div @click="openModal('renamemodal','translate')" class="font-[500] text-[10px] leading-[12px]  text-darkGrey hover:bg-tamkinLight  rounded-[4px] w-full p-1 h-[18px]">
            Rename
        </div>
        ...
        <div class="text-[#141C24] font-[500] text-[12px] leading-[16px] mt-[10px] pl-[15px]">
            AAAAAAAAAAAA
        </div>
