...
const changeColorBasedOnCurrenttab = computed(()=>{
    return packagesStore.currentTabTitle === 'Media'? 

    'bg-gradient-to-l from-[#403E3E] via-[#8878CD] to-[#2B2357]' : 
    packagesStore.currentTabTitle === 'Documents' ?  'bg-[#0E4F7E]': 
    packagesStore.currentTabTitle === 'Images' ?  'bg-gradient-to-l from-[#DBBFBB] via-[#1B71A2] to-[#1A756A]':
    packagesStore.currentTabTitle === "Bundle"  ? 'bg-gradient-to-t  from-[#2DB9B0] to-[#343141] ':''
...
<template>
    ...
    <div class="h-[200px] w-full   relative flex items-start justify-center"
    :class="changeColorBasedOnCurrenttab"
    >
        <!-- <div class="absolute " >
          <img src="/imgs/moon.png" class="w-[203px] h-[203px]" alt="">
        </div> -->
     <!-- MEDIA IMAGES-->
     <div class="absolute left-0 bottom-[0]" v-if="packagesStore.currentTabTitle === 'Media'">
        <img src="/imgs/media_vector_1.png" class="w-[110px] h-[120px]" alt="">
      </div>
      
    

    <div class="absolute right-[14px] inset-y-[30px]" v-if="packagesStore.currentTabTitle === 'Media'">
      <img src="/imgs/media_vector_2.png" class="w-[195px] h-[165px]" alt="">
    </div>
     <!-- END OF MEDIA IMAGES-->

     <!-- START OF DOCUMENTS IMAGES-->
     <div class="absolute left-0 bottom-[0]" v-if="packagesStore.currentTabTitle === 'Documents'">
        <img src="/imgs/docs_vector_1.png"  class="w-[231px] h-[194px]" alt="">
      </div>
      
    

    <div class="absolute right-[14px] inset-y-[10px]" v-if="packagesStore.currentTabTitle === 'Documents'">
     ...
     <!--- START OF IMAGES  -->
     <div class="absolute left-0 bottom-[0]" v-if="packagesStore.currentTabTitle === 'Images'">
        <img src="/imgs/images_vector_1.png"  class="w-[194px] h-[163px]" alt="">
      </div>
      
    

    <div class="absolute right-[14px] inset-y-[20px]" v-if="packagesStore.currentTabTitle === 'Images'">
    ...
    <!--- START OF Bundle  -->
    <div class="absolute left-[14px] bottom-[0]" v-if="packagesStore.currentTabTitle === 'Bundle'">
        <img src="/imgs/bundle_vector_1.png"  class="w-[166px] h-[166px]" alt="">
      </div>
      
      <div class="absolute inset-x-auto inset-y-6" v-if="packagesStore.currentTabTitle === 'Bundle'">
        <img src="/imgs/bundle_vector_2.png" class="w-[155px] h-[178px]" alt="">
      </div>

    <div class="absolute right-[14px] inset-y-[20px]" v-if="packagesStore.currentTabTitle === 'Bundle'">
        ...
        <div class="flex items-center justify-center space-x-[22px] absolute bottom-0">
          ...
          <div v-for="linkPackage in packagesStore.types" :key="linkPackage.name"
            ...
            @click="()=>{
              ...
              $router.push({ path: localePath(getLinkbasedOnTitle(linkPackage)) })
            }"
