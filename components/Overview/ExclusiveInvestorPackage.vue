...
<template>
    ...
    <div class="mt-[30px] bg-white dark:bg-tamkinDarkPrimary rounded-[10px] h-full pb-[24px] w-full shadow-md -shadow-y-[1px]" >
        ...
        <div class="flex items-center justify-end rtl:space-x-reverse space-x-[10px]  px-[15px] order-2 cursor-pointer" @click="packagesStore.showMoreINInvestors = !packagesStore.showMoreINInvestors">
          <div>
 ...
 <PackagesInveestorsPackages class="!pt-[0px] !px-[15px]" :current-type="'Investors'"/>
      </div>
</template>