        ...
        <div class="w-full h-full rounded-[10px]">
          <div class=" w-full h-full  rounded-[10px]" >
           <div
             ...
             bg-transparent
            justify-between mt-[30px] w-full  "
           ...
           >
             ...
             <div
              @click="openModal('shareModal','embed-code')"
               class="lg:order-2 order-3 cursor-pointer ipad-max:text-[12px] border-[2px]  mx-auto lg:m-0 md:mt-0 mt-4 lg:mt-0 md:w-auto w-full lg:w-auto
             ...
             <div @click="copyCode"
               class="cursor-pointer lg:order-3 order-2  md:order-3 ipad-max:text-[12px] border-[2px] rounded-lg border-transparent
