    ...
    >
      <div class="flex items-center justify-start pt-[16px] relative">
        <div class="flex flex-col items-start justify-center relative">
          ...
          <div
            class="py-[24px] border-t-[2px] border-b-[2px] dark:border-light border-lightGrey mt-[32px]"
            v-if="!collapseStore.collapses.includes('custom_trigger_card')"
          >
            <p
              class="text-[13px] leading-[22px] font-[400] text-darkGrey pt-[6px] dark:text-whiteTamkin"
            >
      ...
      >
        <div
          class="h-[55px] bg-[#FAFCFE] dark:bg-tamkinDarkPrimary dark:border-light p-[6px] flex items-center justify-start w-full px-[15px] mt-[16px] border-b-[2px] border-lightGrey"
        >
          <div class="flex items-center justify-start space-x-[13px] w-full">
            ...
            <div class="ltr:ml-auto rtl:mr-auto">
              <label for="toggle_custom_trigger" class="toggle_wrap">
                ...
                <div
                  class="toggle_parent"
                  :class="[isChecked('enable_custom_trigger') ? 'active' : 'in_active']"
                >
                  <div
                    class="toggle_inner"
        ...
        <div
          class="   "
          :class="[!state.custom_id ? 'w-full max-w-[1060px]' : 'max-w-[1060px] w-full']"
          v-if="isChecked('enable_custom_trigger')"
        >
          <Client-only>
            <VCodeBlock
