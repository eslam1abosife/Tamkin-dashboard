  ...
  <Html :lang="htmlAttrs.lang" :dir="htmlAttrs.dir">
    <div class="mx-auto min-h-screen dark:bg-darkTamkin relative">
      ...
      <div class="grid grid-cols-12 lg:gap-[20px]">
        ...
        <div v-if="loadedfn"
          class="dark:[background:#383f4a;] lg:block md:hidden hidden col-span-12 md:col-span-4 w-2/4 lg:col-span-6 fixed top-0 bottom-0 rtl:left-0 ltr:right-0 z-50 overflow-hidden bg-gradient-to-b from-tamkinStart to-tamkinEnd rtl:order-2 order-2 !z-[1]"
        >
          <Vue3Lottie
