<template>
  ...
  >
    ...
    <div class="space-y-4">
      ...
      <label class="flex items-center space-x-2 p-2 bg-white rounded-lg">
        <input
          v-model="createGroup"
          type="checkbox"
          class="form-checkbox text-teal-500 border-gray-300 rounded focus:ring-teal-500"
        />
        <span class="text-gray-700">Create Group</span>
      </label>
      <button
