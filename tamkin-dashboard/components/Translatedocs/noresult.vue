...
<template>
   <div>
    ...
    <div class="flex flex-col items-center space-y-[10px] justify-center mt-[60px] ">
        ...
        <div class="text-[13px] md:text-[15px] font-[500] text-darkGrey dark:text-white/70 leading-[16px]">
            {{ $t('No results found') }}
        </div>
        <div class="font-[400] text-[10px] leading-[16px] dark:text-white">
            I{{$t('t seems we can’t find any results based on your search.')}}
        </div>
