    ...
    <div class="container mx-auto h-full max-h-[100%]">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-light">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-light w-full">
            ...
            <tr v-for="n in 2" :key="n">
              <td
                class="py-4 flex items-center rtl:space-x-reverse space-x-4 animate-pulse"
              >
      ...
      >
        <table
          ...
          class="min-w-full divide-y divide-gray-200 dark:divide-light"
        >
          <thead>
            <tr>
              <th
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-light">
            <tr v-for="app in filteredApps" :key="app.name">
              <td class="py-4 flex items-center rtl:space-x-reverse space-x-4">
                ...
                <div
                  v-else-if="!app.favicon && app.title !== 'Internal Service'"
                ...
                <img
                  ...
                  class="w-[40px] h-[40px]"
                  v-if="app?.title === 'Internal Service'"
                />
        ...
        <h6
          v-if="errMsg"
          class="absolute bottom-[-13px] left-[34%] text-center text-[red] font-light text-[14px]"
        >
          {{ $t(errMsg) }}
        </h6>
      </div>
