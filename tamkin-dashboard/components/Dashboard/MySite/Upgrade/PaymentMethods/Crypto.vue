...
<template>
  <div class="flex flex-col items-start justify-center w-full" v-if="showModal">
    <div class="flex items-center justify-between gap-3">
      <div
        @click="
          navigateTo('crypto', 'add-site', 'paymentMethods');
          removePromoCode();
        "
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                class="flex items-start flex-col justify-center space-y-[-4px]"
              >
                <div
                ...
                >
                  Pay Via {{ selectedCrypto.code }} and get
                  <span class="text-[14px] font-[700]">20%</span> discount
                </div>
              </div>
            </div>
            ...
            <div class="relative w-full">
                ...
                <div class="flex items-center justify-start" v-else>
                  ...
                  <div class="rtl:mr-auto ltr:ml-auto">
                    ...
                    >
                      0.00009
                      {{
                        selectedCrypto.name === "ETH"
                          ? "EHT"
                          : selectedCrypto.name === "BNB"
                          ? "BNB"
                          : "USDT"
                      }}
                    </div>
                  ...
                  <img
                    ...
                    class="rtl:mr-[24px] ltr:ml-[24px] rtl:ml-[20px] ltr:mr-[55px] mb-[2px] rtl:float-left ltr:float-right stroke-current fill-darkGrey dark:fill-whiteTamkin dark:text-whiteTamkin text-darkGrey w-[10px] h-[10px]"
                  />
                </div>
              </button>
              <div
              ...
              >
                <ul>
                  ...
                  >
                    <img :src="cryptoMethod.flag" class="w-[30px] h-[30px]" />
                    <span
                      class="rtl:mr-[16px] ltr:ml-[16px] text-[16px] leading-[24px] font-[500] text-[#3D3D3D] dark:text-whiteTamkin"
                      >{{ cryptoMethod.name }}</span
                    >
                    <div
                      class="rtl:mr-auto ltr:ml-auto rtl:ml-[72px] ltr:mr-[72px]"
                    >
                      <div
                        class="text-[16px] leading-[24px] font-[500] text-[#878787] dark:text-whiteTamkin"
                      >
                        0.00009
                        {{
                          cryptoMethod.name === "ETH"
                            ? "EHT"
                            : cryptoMethod.name === "BNB"
                            ? "BNB"
                            : "USDT"
                        }}
                      </div>
        ...
        >
          ...
          <div
            class="rounded-[10px] custom-border-tamkin padding-override-1 w-[270px] h-[54px] flex items-center justify-center mx-auto"
          >
            <h3 class="">
              <div
                class="flex items-center justify-start rtl:space-x-reverse space-x-[13px]"
              >
                ...
                >
                  ...
                  <span class="text-black font-[500] dark:text-whiteTamkin"
                    >1.938344 {{ selectedCrypto.name }}</span
                  >
                </div>
                <div>
                  <img
        ...
        <table class="min-w-full">
          ...
          <tbody>
            ...
            >
              ...
              <td
                class="py-2 pr-4 border-b text-right w-full font-[500] dark:text-whiteTamkin"
                colspan="2"
              >
                $50,444.00
              </td>
            ...
            >
              ...
              <td
                class="py-2 px-3 border-b text-right w-full font-[500] dark:text-whiteTamkin"
                colspan="2"
              >
                EHT 1.938344
              </td>
      ...
      <div class="mt-[39px] mx-auto mb-[34px]">
        <button
          class="btn-dashboard hover_tamkin !h-[40px] lg:w-[535px] w-full"
          @click="navigateTo('crypto', 'add-site', 'cryptosend')"
          v-if="!loading"
        >
          Confirm Payment
        </button>
        <button
          class="processing_payment !h-[40px] lg:w-[535px] w-full"
          v-else
          disabled
        >
          Loading..
