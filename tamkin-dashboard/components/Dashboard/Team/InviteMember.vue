...
<template>
  <div
    ...
    class="fixed z-[9999] bg-white dark:bg-tamkinDarkPrimary rounded-[10px] p-[30px] lg:w-[640px] lg:h-[446px] w-10/12 left-1/2 -translate-x-1/2 top-1/2 md:top-[100px] max-md:-translate-y-1/2"
  >
    <div
