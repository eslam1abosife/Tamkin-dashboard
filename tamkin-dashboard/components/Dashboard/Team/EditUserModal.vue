...
const { inviteAppsForMember, getMemberInviteApps } =
  useGetTeamMemberInviteApps();
...
<template>
  ...
  >
    ...
    <div class="container mx-auto">
      ...
      <div
        class="flex items-center dark:border-darkborder rtl:space-x-reverse space-x-[12px] justify-start ipad-max:mt-0 mt-[32px] border-[1px] border-t border-b-0 border-l-0 border-r-0 pt-[16px]"
      >
        <div>
          <div
            v-if="getAppsLoading"
            class="w-[56px] h-[56px] bg-gray-200 dark:bg-p rounded-full animate-pulse"
          ></div>
          <div
        ...
        <div class="flex flex-col items-start justify-center">
          <div>
            <h2
              v-if="getAppsLoading"
              class="w-[150px] h-[16px] bg-gray-200 dark:bg-p rounded animate-pulse"
            ></h2>
            <h2
              v-else
          ...
          <div>
            <h2
              v-if="getAppsLoading"
              class="w-[100px] h-[14px] bg-gray-200 dark:bg-p rounded animate-pulse mt-[8px]"
            ></h2>
            <h2
              v-else
        ...
        <div v-if="getAppsLoading" class="w-[99%]">
          ...
          >
            <div class="flex items-center rtl:space-x-reverse space-x-4">
              <div class="w-6 h-6 bg-gray-200 dark:bg-p rounded"></div>
              <div
                class="w-[150px] h-[14px] bg-gray-200 dark:bg-p rounded"
              ></div>
            </div>
            <div class="w-[18px] h-[18px] bg-gray-200 dark:bg-p rounded"></div>
          </div>
        </div>
            ...
            >
              <td class="py-4 flex items-center rtl:space-x-reverse space-x-4">
                ...
                <img
                  ...
                  class="w-[40px] h-[40px]"
                  v-if="
                    permission?.title === 'Internal Service' && !getAppsLoading
                  "
                />
