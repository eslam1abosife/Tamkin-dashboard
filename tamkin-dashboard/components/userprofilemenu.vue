...
"
  ...
  <nuxt-link :to="localePath('/profile')" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
      <div>
  ...
  <nuxt-link :to="localePath('/subscriptions')" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
      <div>
        <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <nuxt-link :to="localePath('/billing')" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
      <div>
        <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <nuxt-link  :to="localePath('/orders')" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
    <div>
  ...
  <nuxt-link :to="localePath('/referral')" class="cursor-pointer p-[10px] flex items-center justify-start w-full  space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]">
      <div>
