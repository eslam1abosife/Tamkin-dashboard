...
<template>
  ...
  >
    ...
    <div
      ...
      class="p-[10px] w-full absolute top-[60px] right-[-0.5px] bg-white rounded-[10px] h-auto w-full rounded-b-[10px] flex flex-col items-start justify-start"
    >
      <nuxt-link
        :to="localePath('/profile')"
        class="cursor-pointer p-[10px] flex items-center justify-start w-full space-x-[10px] rtl:space-x-reverse hover:bg-tamkinLight rounded-[10px]"
      >
        <div>
          <svg
            width="12"
