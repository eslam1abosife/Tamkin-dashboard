...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div class="flex items-center justify-start w-full space-x-[14px]">
          <div class="w-2/4">
            <div
              class="ipad-max:w-[30px] ipad-max:h-[30px] w-[40px] dark:bg-p h-[40px] bg-gray-300 rounded-full"
            ></div>
          </div>
          <div class="flex flex-col items-start justify-center w-full !mx-0">
            <div class="h-[10px] dark:bg-p bg-gray-300 rounded-full w-24"></div>
            <div
              class="h-[12px] dark:bg-p bg-gray-300 rounded-full mt-1 w-16"
            ></div>
          </div>
          <div
            class="w-[16px] h-[16px] dark:bg-p bg-gray-300 rounded-full"
          ></div>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div
        class="my-[13px] max-md:px-[10px] flex gap-x-1 gap-y-2 flex-col md:flex-row md:items-center justify-center w-full"
      >
        <div
