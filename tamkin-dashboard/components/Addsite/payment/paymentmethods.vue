  ...
  >
    ...
    <div class="w-full h-full">
      <div class="flex flex-col items-start justify-center w-full">
        ...
        <div>
          <h1
            class="text-[16px] lg:text-[18px] rtl:font-[Almarai] leading-[36px] font-[600] dark:text-whiteTamkin text-darkGrey rtl:mr-[20px] ltr:ml-[20px] mt-5"
          >
        ...
        >
          ...
          <div
            class="flex flex-col items-start justify-center space-y-[12px] mt-[50px] w-full px-[5px] lg:px-[20px]"
          >
            <div class="w-full">
              <div
                @click="addSiteStore.selectedPaymentMethod = 'by_card'"
                :class="[
                  addSiteStore.selectedPaymentMethod == 'by_card'
              ...
              >
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    ...
                    class="hidden"
                    value="by_card"
                    v-model="addSiteStore.selectedPaymentMethod"
                    :checked="addSiteStore.selectedPaymentMethod === 'by_card'"
                  />
                  <label
                    for="radio5"
            ...
            <div class="w-full">
              <div
                ...
                :class="[
                  addSiteStore.selectedPaymentMethod == 'by_crypto' &&
                  addSiteStore.packagePayload.payDateType !== 'trial'
                    ? 'custom-border-tamkin'
                    : 'border-[1px] ',

                  addSiteStore.packagePayload.payDateType === 0
              ...
              >
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    ...
                    class="hidden"
                    value="by_crypto"
                    :disabled="addSiteStore.packagePayload.payDateType === 0"
                    v-model="addSiteStore.selectedPaymentMethod"
                    :checked="
                      addSiteStore.selectedPaymentMethod === 'by_crypto' &&
          ...
          <div
            class="my-[26px] px-[20px] rtl:mr-auto ltr:ml-auto w-full md:w-[50%]"
          >
            <button
              class="btn-dashboard hover_tamkin"
              :disabled="!addSiteStore.selectedPaymentMethod"
              @click="goToPaymentMethod(addSiteStore.selectedPaymentMethod)"
            >
