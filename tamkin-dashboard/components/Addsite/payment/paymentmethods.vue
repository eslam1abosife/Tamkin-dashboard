...
const goToPaymentMethod = async (method: any) => {
  ...
  if (addSiteStore.selectedPaymentMethod === 'by_card') {
    // addSiteStore.promo = "";
    // addSiteStore.currentDiscount = 0;
    // addSiteStore.validPromo = false;
    return navigateTo('payment_methods_addsite', 'addSite', 'cardModal_addsite')
  }

  if( addSiteStore.packagePayload.payDateType !== 'trial' ){
    if (addSiteStore.selectedPaymentMethod=== 'by_paypal') {
    // addSiteStore.promo = "";
    // addSiteStore.currentDiscount = 0;
    // addSiteStore.validPromo = false;
    return navigateTo('payment_methods_addsite', 'addSite', 'paypal_addsite')

    // const res = await createOrder('paypal')
    // console.log(res.headers.location)
  }
  if (addSiteStore.selectedPaymentMethod === 'by_crypto') {
    // addSiteStore.promo = "";
    // addSiteStore.currentDiscount = 0;
    // addSiteStore.validPromo = false;
    return navigateTo('payment_methods_addsite', 'addSite', 'crypto_addsite_step1')
...
<template>
  ...
  <div v-if="isOpen('payment_methods_addsite')"
   ...
   dark:bg-tamkinDarkPrimary dark:text-whiteTamkin !top-[23px]" @click="()=>{
    closeModal('payment_methods_addsite')
    ...
    <div class="w-full h-full">
      ...
      <div class="flex flex-col items-start justify-center w-full">
        ...
        <div class="flex items-center justify-center">
          <div @click="navigateTo('payment_methods_addsite', 'addSite', 'add_package_modal_addsite')" 
    ...
    ">
        ...
        <div
          ...
          <div class="flex flex-col items-start justify-center space-y-[12px] mt-[50px] w-full px-[5px] lg:px-[20px]">
            <div class="w-full">
              <div @click="addSiteStore.selectedPaymentMethod = 'by_card'"
                :class="[addSiteStore.selectedPaymentMethod == 'by_card' ? 'custom-border-tamkin' : 'border-[1px] ']"
            ...
            flex items-center justify-between rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]">
                ...
                <div class="order-1 mx-[4px]">
                  ...
                  v-model="addSiteStore.selectedPaymentMethod" :checked="addSiteStore.selectedPaymentMethod === 'by_card'" />
            ...
            <div class=" w-full ">
              <div @click="()=>{
                ...
                if(addSiteStore.packagePayload.payDateType !== 0){

                  addSiteStore.selectedPaymentMethod = 'by_crypto';
                }
              }"
                :class="[addSiteStore.selectedPaymentMethod == 'by_crypto' &&  addSiteStore.packagePayload.payDateType !== 'trial' ? 'custom-border-tamkin' : 'border-[1px] ',
                
                addSiteStore.packagePayload.payDateType === 0 ?'!cursor-not-allowed opacity-50' :''
             ...
             rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]">
                ...
                <div class="order-1 mx-[4px]">
                  ...
                  :disabled="addSiteStore.packagePayload.payDateType === 0"  v-model="addSiteStore.selectedPaymentMethod" :checked="addSiteStore.selectedPaymentMethod === 'by_crypto' && addSiteStore.currentPackage.trial_days === 0" />
            ...
            <div class=" w-full ">
              <div @click="()=>{
                ...
                if(addSiteStore.packagePayload.payDateType !== 0){
                  ...
                  addSiteStore.selectedPaymentMethod = 'by_paypal';
                }
              }"
                :class="[addSiteStore.selectedPaymentMethod == 'by_paypal'  && addSiteStore.packagePayload.payDateType !== 'trial' ? 'custom-border-tamkin' : 'border-[1px] ',
                addSiteStore.packagePayload.payDateType === 0  ?'!cursor-not-allowed opacity-50' :''
            ...
            justify-between rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]">
                ...
                <div class="order-1 mx-[4px]">
                  ...
                  :disabled="addSiteStore.packagePayload.payDateType === 0"  v-model="addSiteStore.selectedPaymentMethod" :checked="addSiteStore.selectedPaymentMethod === 'by_paypal' && addSiteStore.currentPackage.trial_days === 0" />
          ...
          <div class="my-[26px] px-[20px] rtl:mr-auto ltr:ml-auto">
            <button class="btn-dashboard hover_tamkin" :disabled="!addSiteStore.selectedPaymentMethod" @click="goToPaymentMethod(addSiteStore.selectedPaymentMethod)">
