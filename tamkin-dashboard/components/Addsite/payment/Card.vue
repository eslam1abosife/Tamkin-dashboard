                ...
                <div class="flex items-center justify-start rtl:space-x-reverse space-x-[13px] w-full">
                  ...
                  <div class="flex items-center justify-between w-full">
                    <div class="flex flex-col items-start justify-start relative w-full">
                      ...
                      <div class="text-darkGrey dark:text-white text-[13px] font-[400] leading-[10px]">
              ...
              <div
                ...
                <div class="lg:py-[17px] search_input max-md:flex-1 lg:w-3/4 mt-[24px]">
                  ...
                  <div
                    ...
                    <img src="/assets/imgs/promo_valid_.svg" class="max-md:w-5" />
                  </div>
                  <div v-if="
              ...
              <tbody>
                ...
                <tr class="text-[16px] leading-[24px] font-[500] bg-[#FAFCFE] dark:bg-tamkinDarkPrimary">
                  ...
                  <td
                    ...
                    ${{
                      (
                        Number(addSiteStore.packagePayload.total) -
                        percentageOff
                      )
                        .toFixed(0)
                        .toString()
