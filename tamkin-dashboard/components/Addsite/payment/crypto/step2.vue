...
import { usePayByCrypto } from "@/composables/useAddSite";
import { useClipboard } from '@vueuse/core'
const cryptostore = useCryptoStore();
const addSiteStore = useAddSiteStore();
const source = addSiteStore.selectedCrypto.wallet_address
...
const {  paywithCrypto,messageData,codeStatus} = usePayByCrypto();
...
const payCrypto = async () => {
 ...
 `${ convertUsdToCrypto(
  addSiteStore.packagePayload.total - addSiteStore.currentDiscount,
                  ...
                  addSiteStore.selectedCrypto.code
  ...
  navigateTo("crypto_addsite_step2", "addSite", "crypto_addsite_success");
...
const cancelPayment =()=>{
  ...
  addSiteStore.urls =[]
  closeModal('crypto_addsite_step2')
}
</script>
      ...
      <div class="flex flex-col items-start justify-center w-full">
        <div class="flex flex-col items-start justify-center w-full relative">
          <div class="flex items-center justify-center">
            <div
              @click="navigateTo('crypto_addsite_step2', 'marpackagesket', 'crypto_packages_step1')"
          ...
          >
            ...
            >
              <!-- here-->
              <div
                class="h-[50px] w-full bg-[#FAFCFE] dark:bg-tamkinDarkPrimary border-[1px] border-lightGrey dark:border-light rounded-[10px] mb-[24px] flex items-center justify-start rtl:space-x-reverse space-x-[10px] px-[10px]"
              >
                <div>
              ...
              <div class="border rounded-lg">
                <vue-qrcode
                  :value="addSiteStore.selectedCrypto.wallet_address"
                ...
                <div class="w-full">
                  ...
                  >
                    ...
                    <span class="text-tamkin">
                      ...
                      {{ addSiteStore.selectedCrypto.title }}</span
                    >
                  </h2>
                  <div
