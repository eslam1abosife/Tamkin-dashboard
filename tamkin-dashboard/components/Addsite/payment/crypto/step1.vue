      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="flex items-center justify-between w-full px-4 md:px-[20px]"
            >
            ...
            <table class="min-w-full">
              ...
              <tbody>
                ...
                >
                  ...
                  <td
                    class="py-2 px-5 whitespace-nowrap border-b dark:border-darkborder text-right w-full dark:text-whiteTamkin"
                    colspan="2"
                  >
                    ${{ percentageOff }}
                  </td>
                ...
                >
                  ...
                  <td
                    class="py-2 px-5 border-b whitespace-nowrap dark:border-darkborder text-right w-full font-[500] dark:text-whiteTamkin"
                    colspan="2"
                  >
