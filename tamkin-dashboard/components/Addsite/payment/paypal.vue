...
<template>
  <div v-if="isOpen('paypal_addsite')"
          ...
          <div class="flex flex-col items-center justify-center space-y-[12px] mx-auto w-full">
            <div
              ...
              <div class="text-center mt-[24px] w-auto md:w-2/6">
                <button
                  class="btn-dashboard dark:bg-p dark:text-whiteTamkin max-md:!text-[13px] hover_tamkin w-full mx-auto text-center text-nowrap"
            ...
            <table class="min-w-full">
              ...
              <tbody>
                ...
                <tr v-if="addSiteStore.validPromo"
