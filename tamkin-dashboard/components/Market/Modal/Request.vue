...
// and after the form is reset with saved custom character data, it will be set to true and the condition will be false
// and the form reset process will not be made again
