...
<<<<<<< HEAD
  <div
    v-if="isOpen('paymentMethods_market')"
    ...
    <div class="w-full h-full">
      <div class="flex flex-col items-start justify-center w-full">
        <div class="flex items-center justify-center">
          ...
          <h1
            class="text-[16px] lg:text-[18px] rtl:font-[Almarai] leading-[36px] font-[600] dark:text-whiteTamkin text-darkGrey ltr:ml-[20px] rtl:mr-[20px] lg:mt-0"
          >
  ...
  <div v-if="isOpen('paymentMethods_market')"
    ...
    <div class="w-full h-full">
        ...
        <div class="flex items-center justify-between">
         ...
         dark:bg-tamkinDarkPrimary dark:text-whiteTamkin !top-[23px]" @click="() => {
          ...
          <div class="flex items-center gap-3">
            <div @click="navigateTo('paymentMethods_market', 'market', 'mycart')" class="cursor-pointer close_sidebar_btn group flex items-center justify-center  
      ...
      ">
            ...
            <h1
              class="text-[16px] lg:text-[18px] rtl:font-[Almarai]  leading-[36px] font-[600] dark:text-whiteTamkin text-darkGrey mb-0">
              {{ $t('Choose Payment Methods') }}
            </h1>
          </div>
...
>>>>>>> 91f1f9d06e737c0ee3461ff4cab4d59971e81d0f
          ...
          <div
            class="flex flex-col items-start justify-center space-y-[12px] mt-[50px] w-full px-[20px]"
          >
            <div class="w-full">
<<<<<<< HEAD
              <div
                @click="marketStore.selectedPaymentMethod = 'by_card'"
                :class="[
                  marketStore.selectedPaymentMethod == 'by_card'
              ...
              >
                ...
                >
                  <div>
                    <img
                      src="/assets/imgs/payment_methods/cc.svg"
                      class="w-[40px] h-[40px]"
                    />
                  </div>
                  <div
                    class="text-[16px] leading-[44px] font-[600] ltr:font-[Poppins] rtl:font-[Almarai] text-darkGrey dark:text-whiteTamkin"
                  >
                    {{ $t("Pay Via Card") }}
                  </div>
                </div>
                <div class="order-1 mx-[4px]">
                  <input
                    ...
                    class="hidden"
                    value="by_card"
                    v-model="marketStore.selectedPaymentMethod"
...
<<<<<<< HEAD
            <div class="w-full">
              <div
                @click="marketStore.selectedPaymentMethod = 'by_crypto'"
                :class="[
                  marketStore.selectedPaymentMethod == 'by_crypto'
                    ? 'custom-border-tamkin'
                    : 'border-[1px] ',
                ]"
                class="mx-auto w-full h-[87px] cursor-pointer bg-[#FAFCFE] dark:bg-tamkinDarkPrimary flex items-center justify-between rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]"
...
=======
            <div class=" w-full ">
              <div @click="marketStore.selectedPaymentMethod = 'by_crypto'"
                :class="[marketStore.selectedPaymentMethod == 'by_crypto' ? 'custom-border-tamkin' : 'border-[1px] ']"
...
<<<<<<< HEAD
            <div class="w-full">
              <div
                @click="marketStore.selectedPaymentMethod = 'by_paypal'"
                :class="[
                  marketStore.selectedPaymentMethod == 'by_paypal'
                    ? 'custom-border-tamkin'
                    : 'border-[1px] ',
                ]"
                class="mx-auto w-full h-[87px] cursor-pointer bg-[#FAFCFE] dark:bg-tamkinDarkPrimary flex items-center justify-between rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]"
              >
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    ...
                    value="by_paypal"
                    v-model="marketStore.selectedPaymentMethod"
                    :checked="marketStore.selectedPaymentMethod === 'by_paypal'"
                  />
                  <label
                    for="radio_paypal"
                    class="flex items-center cursor-pointer ltr:pr-[40px] rtl:pl-[40px]"
...
=======
            <div class=" w-full ">
              <div @click="marketStore.selectedPaymentMethod = 'by_paypal'"
                :class="[marketStore.selectedPaymentMethod == 'by_paypal' ? 'custom-border-tamkin' : 'border-[1px] ']"
...
<<<<<<< HEAD
          <div class="my-[26px] px-[20px] rtl:mr-auto ltr:ml-auto">
            <button
              ...
              :disabled="!marketStore.selectedPaymentMethod"
              @click="goToPaymentMethod(marketStore.selectedPaymentMethod)"
            >
              {{ $t("Continue to Payment") }}
=======
          <div class="my-[26px] px-[20px] rtl:mr-auto ltr:ml-auto w-full md:w-auto">
            <button class="btn-dashboard hover_tamkin" :disabled="!marketStore.selectedPaymentMethod"
              @click="goToPaymentMethod(marketStore.selectedPaymentMethod)">
              {{ $t('Continue to Payment') }}
>>>>>>> 91f1f9d06e737c0ee3461ff4cab4d59971e81d0f
            </button>
