          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  class="text-[11px] md:text-[14px] font-[600] leading-[24px] text-darkGrey dark:text-whiteTamkin"
                >
                  {{ $t("Add New Card") }}
                </div>
              </div>
              ...
              >
                <div class="cursor-pointer">
                  <div
                    class="ltr:text-[11px] rtl:ltr:text-[11px] rtl:text-[13px] md:text-[14px] font-[500] underline leading-[24px] text-darkGrey dark:text-whiteTamkin"
                  >
