...
? 'stroke-current !text-white !fill-white' : 'dark:text-white',
    ...
    <div
      class="w-full mt-[24px] mx-auto bg-white dark:bg-tamkinDarkPrimary rounded-lg space-y-[16px] lg:overflow-x-hidden overflow-x-auto"
      ...
      <div class="flex flex-col items-center justify-center w-full space-y-[6px]">
        ...
        <div class="w-full flex items-center rtl:space-x-reverse space-x-2">
          <div
            ...
            class="rounded-full h-4 w-full relative overflow-hidden"
          >
            <div class="bg-[#D7F5F2] h-full rounded-r-full" style="width: 40%"></div>
          </div>
        </div>
      </div>
    </div>
