...
<template>
    ...
    <div
    class="my-[30px] bg-white  dark:bg-tamkinDarkPrimary rounded-[10px]
     px-[15px] pb-[24px] shadow-md -shadow-y-[1px] relative"
    
  >
    <div class="flex items-center justify-start ">
      <div class="pt-[24px]">
        <h1 class="text-[14px] lg:text-[18px] font-[500] leading-[30px] dark:text-whiteTamkin">Usage reports</h1>
      ...
      <div
        @click.stop="collapseStore.collapseMenu('balance')"
        v-on-click-outside="() => collapseStore.removeMenu('balance')"

        :class="[
          collapseStore.menus.includes('balance')
...
? 'stroke-current !text-white !fill-white' : 'dark:text-white',
        ...
        <div
          v-if="collapseStore.menus.includes('balance')"
    ...
    <div
    class="flex items-start  w-full justify-evenly pt-[16px] "
  >
    <div
    ...
    >
      <div class="flex items-center justify-between space-x-[6px]">
        ...
        ></span>
        <span class="text-gray-500 text-[14px] dark:text-whiteTamkin">Your total minutes </span>
      </div>
    ...
    >
      <div class="flex items-center justify-center space-x-[6px]">
        ...
        ></span>
        <span class="text-gray-500 text-[14px] dark:text-whiteTamkin">Remaining</span>
      </div>
