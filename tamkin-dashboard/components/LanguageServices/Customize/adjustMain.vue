...
const { WebpluginsCards, initialCardsOrder } = storeToRefs(signLangStore);
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="[
        collapseStore.collapses.includes('adjust_main_menu_customize_sign_card')
          ? 'pb-[24px]'
          : 'pb-[10px]',
      ]"
    >
      <div class="flex items-center justify-start pt-[21px]">
        <div>
          ...
          >
            Manage Your Sign Language Settings for a Customized and Accessible
        ...
        <div
          @click.stop="
            collapseStore.collapseMenu('adjust_main_menu_customize_sign')
          "
          v-on-click-outside="
            () => collapseStore.removeMenu('adjust_main_menu_customize_sign')
          "
          :class="[
        ...
        >
          ...
          >
            ...
            <div
              class="mini_wrap"
              @click="
                collapseStore.collapseCard(
                  'adjust_main_menu_customize_sign_card'
                )
              "
            >
              <div>
              ...
              >
                ...
                >
                  <img
                    ...
                    class="w-[24px]"
                    :class="[
                      !isChecked(element.checkboxId) ? 'opacity-60' : '',
                    ]"
                  />
                </div>
                ...
                <div class="ml-auto">
                  <label :for="element.checkboxId" class="toggle_wrap">
                    <input
                      ...
                      @change="
                        customizeStore.toggleCheckbox(element.checkboxId)
                      "
                    />
                    <div
                      class="toggle_parent"
