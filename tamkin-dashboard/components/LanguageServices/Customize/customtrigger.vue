  ...
  <div class="flex flex-col items-center justify-center w-full mt-[40px] relative mb-[80px]">
    <div class="bg-white dark:bg-tamkinDarkPrimary rounded-[10px] w-full px-[15px] relative shadow-md -shadow-y-[1px]"
      ...
      <div class="flex flex-col items-start justify-center mt-[18px] max-w-full"
          ...
          <div class="flex items-center justify-start space-x-[13px] w-full">
            ...
            <div class="ltr:ml-auto rtl:mr-auto">
              <label for="custom_trigger_id" class="toggle_wrap">
                <input type="checkbox" id="custom_trigger_id" class="sr-only"
                  :checked="isChecked('custom_trigger_id')" @change="toggleCheckbox('custom_trigger_id')" />
                <div class="toggle_parent" :class="[isChecked('custom_trigger_id') ? 'active' : 'in_active']">
                  <div class="toggle_inner" :class="{ active: isChecked('custom_trigger_id') }">
                    <img v-if="isChecked('custom_trigger_id')" src="/assets/imgs/translatevideo/sign_active.svg"
                      class="w-[28px] h-[28px]" />
        ...
        <div class="w-full relative my-[24px]" v-if="isChecked('custom_trigger_id')">
        ...
        <div @click="copyCode" v-if="isChecked('custom_trigger_id')"
