  ...
  >
    <div class="flex items-center justify-start">
      <div class="pt-[24px]">
        ...
        >
          Usage stats by function show how each feature is used in a system or
          app.
        </p>
      </div>
      <div
    ...
    >
      <div class="grid grid-cols-12 gap-4">
        ...
        >
          <div
            class="h-[80px] w-full bg-[#F6FAFF] rounded-[6px] border-[1px] border-[#EAEAEA] flex items-center justify-start p-[10px] space-x-[18px]"
          >
            <div>
              <img
                src="/assets/imgs/signlanguageservices/upload_icon.png"
                class="w-[40px] h-[40px]"
                alt=""
              />
            </div>
          ...
          >
            <div>
              <img
                src="/assets/imgs/signlanguageservices/sign_lang_icon.png"
                class="w-[40px] h-[40px]"
                alt=""
              />
            </div>
          ...
          >
            <div>
              <img
                src="/assets/imgs/signlanguageservices/translation_icon.png"
                class="w-[40px] h-[40px]"
                alt=""
              />
            </div>
        ...
        <div class="w-full col-span-8">
          <div
            class="flex flex-col items-center justify-center w-full space-y-[8px]"
          >
          ...
          >
            ...
            <div class="w-full flex items-center rtl:space-x-reverse space-x-2">
              ...
              >
                <div
                  class="bg-[#D3E1F2] h-full rounded-r-full"
                  style="width: 40%"
                ></div>
              </div>
            </div>
          ...
          >
            ...
            <div class="w-full flex items-center rtl:space-x-reverse space-x-2">
              ...
              >
                <div
                  class="bg-[#FAE1E1] h-full rounded-r-full"
                  style="width: 40%"
                ></div>
              </div>
            </div>
          ...
          >
            ...
            <div class="w-full flex items-center rtl:space-x-reverse space-x-2">
              ...
              >
                <div
                  class="bg-[#FEF3D8] h-full rounded-r-full"
                  style="width: 40%"
                ></div>
              </div>
            </div>
          ...
          >
            ...
            <div class="w-full flex items-center rtl:space-x-reverse space-x-2">
              ...
              >
                <div
                  class="bg-[#D0F5F2] h-full rounded-r-full"
                  style="width: 40%"
                ></div>
              </div>
            </div>
