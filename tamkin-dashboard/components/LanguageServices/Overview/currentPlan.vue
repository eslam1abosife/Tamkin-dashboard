      ...
      <div class="w-full bg-white dark:bg-tamkinDarkPrimary rounded-[10px] h-full shadow-md -shadow-y-[1px]"
        ...
        <div
          ...
          <div class="flex flex-col items-start justify-center w-full px-[15px]">
            <div>
              <!-- Title Placeholder -->
              <div class="h-[30px] w-3/4 dark:bg-tamkinDarkPrimary bg-gray-400 rounded-md mb-2"></div>
              <!-- Subtitle Placeholder -->
              <div class="h-[21px] w-2/3 dark:bg-tamkinDarkPrimary bg-gray-400 rounded-md"></div>
            </div>
            ...
            <div
              ...
              <div class="flex items-center justify-start rtl:space-x-reverse space-x-[4px]">
                <!-- Icon Placeholder -->
                <div class="h-[22px] w-[22px] lg:h-[10px] dark:bg-p lg:w-[10px] dark:bg-p bg-gray-500 rounded-full">
                </div>
                <!-- Text Placeholder -->
                <div class="h-[22px] w-[150px] bg-gray-400 dark:bg-p rounded-md"></div>
              </div>

              <!-- Status Placeholder -->
              <div class="h-[25px] lg:w-[88px] dark:bg-p bg-gray-500 rounded-[17px]"></div>
            </div>
          </div>
        </div>
          ...
          <div
            ...
            <div v-for="n in 3" :key="n"
              ...
              <div class="flex items-center justify-center w-full px-[15px] mt-[48px]">
                <div class="w-full">
                  <div class="bg-gray-300 h-[30px] dark:bg-p_secondary rounded mb-[8px]"></div>
                  <div class="bg-gray-300 h-[20px] dark:bg-p_secondary w-[150px] rounded mb-[16px]"></div>
                  <div class="bg-gray-300 h-[29px] dark:bg-p_secondary w-[100px] rounded"></div>
                  <div class="bg-gray-200 h-[16px] dark:bg-p_secondary w-[120px] mt-[10px] rounded"></div>
                  <div class="bg-gray-200 h-[16px] dark:bg-p_secondary w-[80px] mt-[10px] rounded"></div>
                </div>
              </div>

              <div class="flex flex-col items-start justify-center w-full space-y-[10px] p-4">
                <div class="bg-gray-300 dark:bg-p_secondary h-[20px] w-[200px] rounded"></div>
                <div class="bg-gray-300 dark:bg-p_secondary h-[20px] w-[150px] rounded"></div>
                <div class="bg-gray-300 dark:bg-p_secondary h-[20px] w-[100px] rounded"></div>
                <div class="bg-gray-200 dark:bg-p_secondary w-full h-[40px] rounded-[19px] mt-[20px]"></div>
              </div>
            </div>
          </div>
        </div>
