        ...
        <h1
          ...
          <div class="flex items-center justify-start rtl:space-x-reverse space-x-[8px]">
            ...
            <div v-if="
              ...
              mySiteStore.currentWebsite?.title !== 'Internal Service'
            ">
              <img v-if="mySiteStore.currentWebsite.favicon" :src="mySiteStore.currentWebsite.favicon"
            ...
            <div class="flex items-center rtl:space-x-reverse space-x-[16px]">
              ...
              <div>
                <h2 class="font-[500] text-[14px] leading-[14px] dark:text-whiteTamkin text-darkGrey underline">
              ...
              <div>
                <a :class="[
                  mySiteStore.currentWebsite?.title === 'Internal Service'
                    ...
                    : '',
                ]" :href="mySiteStore.currentWebsite?.title === 'Internal Service'
                  ? '#'
                  ...
                  class="text-tamkin font-[500] text-[14px] leading-[24px] flex">{{ $t("Visit Site") }}
          ...
          <div v-if="mySiteStore.currentPackage.type !== 'Investors'"
            ...
            <button @click="switchBetweenMonthlyAndAnnual('year')" :class="[
              ...
              <div class="flex items-center justify-center rtl:space-x-reverse space-x-[4px]">
                ...
                <div class="text-black dark:text-white font-[800] !text-[10px]">
                  {{
                    packagesStore.types.length ? packagesStore.types.find(type => type.title ===
                      mySiteStore.currentPackage.type).discount_yearly : ''
                  }}%</div>
              </div>
            </button>
          </div>
    ...
    ipad-max:leading-[10px] whitespace-nowrap
                lg:leading-[22.5px] text-darkGrey dark:text-white">
                    {{ $t(mySiteStore.currentPackage.title) }} {{ mySiteStore.currentPackage.title === 'Free' ? ' - '
                      ...
                      ?
                      $t(mySiteStore.currentPackage.type) : $t('Internal Service') }}
        ...
        <div class="w-full mt-[24px] bg-white dark:bg-tamkinDarkPrimary rounded-[10px] h-full shadow-md -shadow-y-[1px]"
          ...
          <div
            class="flex items-center justify-start rounded-[10px] h-[212px] w-full animate-pulse bg-gray-300 dark:bg-darkTamkin">
            <div class="flex flex-col items-start justify-center w-full px-[15px]">
              <div>
                <!-- Title Placeholder -->
          ...
          gap-2  mt-[32px]">
              ...
              >
                ...
                <div class="flex items-center justify-center w-full px-[15px] mt-[48px]">
                  <div class="w-full">
                    <div class="bg-gray-300 dark:bg-darkTamkin h-[30px] rounded mb-[8px]"></div>
                    <div class="bg-gray-300 dark:bg-darkTamkin h-[20px] w-[150px] rounded mb-[16px]"></div>
                    <div class="bg-gray-300 dark:bg-darkTamkin h-[29px] w-[100px] rounded"></div>
                    <div class="bg-gray-200 dark:bg-darkTamkin h-[16px] w-[120px] mt-[10px] rounded"></div>
                    <div class="bg-gray-200 dark:bg-darkTamkin h-[16px] w-[80px] mt-[10px] rounded"></div>
                  </div>
                </div>

                <div class="flex flex-col items-start justify-center w-full space-y-[10px] p-4">
                  <div class="bg-gray-300 dark:bg-darkTamkin h-[20px] w-[200px] rounded"></div>
                  <div class="bg-gray-300 dark:bg-darkTamkin h-[20px] w-[150px] rounded"></div>
                  <div class="bg-gray-300 dark:bg-darkTamkin h-[20px] w-[100px] rounded"></div>
                  <div class="bg-gray-200 dark:bg-darkTamkin w-full h-[40px] rounded-[19px] mt-[20px]"></div>
                </div>
              </div>
            </div>
          </div>
        </div>
        <OverviewWidgetEmbdedCode v-if="mySiteStore.currentWebsite?.title !== 'Internal Service'"
