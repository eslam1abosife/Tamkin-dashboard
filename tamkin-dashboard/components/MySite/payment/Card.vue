...
const gotoPaymentMethod = () => {
  if (chooseOtherPaymentMethod.value === "by_crypto") {
    navigateTo("cardModal_mysite", "mysite", "crypto_mysite_step1");
  } else {
    navigateTo("cardModal_mysite", "mysite", "paypal_mysite");
  }
};
      ...
      <div class="flex flex-col items-start justify-center w-full">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-3">
            <div @click="
              navigateTo('cardModal_mysite', 'mysite', 'payment_methods_mysite')
              "
        ...
        <div
          ...
          <div class="flex flex-col items-center justify-start w-full px-[20px] space-y-[10px] mt-[24px]"
            v-if="loadingCards">
          ...
          <div class="flex flex-col items-center justify-center space-y-[12px] mt-[24px] mx-auto w-full">
                ...
                <div class="flex items-center justify-start rtl:space-x-reverse space-x-[13px] w-full">
                  ...
                  <div class="flex items-center justify-between w-full">
                    <div class="flex flex-col items-start justify-start relative w-full">
                      ...
                      <div class="text-darkGrey text-[13px] dark:text-white/70 font-[400] leading-[10px]">
            ...
            <div v-if="billingStore.cards?.length === 0 && !loadingCards"
              ...
              <div class="flex flex-col items-center justify-center mt-[24px] space-y-[10px]">
                ...
                <div class="text-[14px] leading-[28px] font-[400] text-darkGrey dark:text-white text-center">
            ...
            <div class="flex items-center justify-between w-full px-[20px]" v-if="!loadingCards">
              <div class="flex items-center rtl:space-x-reverse space-x-[5px] md:space-x-[10px] mt-[24px]" @click="
                navigateTo(
                  'cardModal_market',
                  'mysite',
              ...
              <div class="flex items-center rtl:space-x-reverse space-x-[1px] md:space-x-[11px] mt-[24px]"
            ...
            <div class="w-full px-[20px]" v-if="showMoreMethods">
              <div @click="changepaymentMethod('by_crypto')" :class="[
                chooseOtherPaymentMethod == 'by_crypto'
                  ? 'custom-border-tamkin'
                  : 'border-[1px] ',
                mysiteStore.packagePayload.payDateType === 0
                ...
                <div class="order-1 mx-[4px]">
                  <input id="radio_crypto" type="radio" name="radio" class="hidden"
                    :disabled="mysiteStore.packagePayload.payDateType === 0" :class="[
                      mysiteStore.packagePayload.payDateType === 0
                        ? '!cursor-not-allowed opacity-50'
                        : '',
            ...
            <div class="flex flex-col items-center justify-center space-y-[12px] mx-auto w-full">
              <div
                ...
                <div class="lg:py-[17px] search_input w-full lg:w-3/4 mt-[24px]">
                  <input type="text" @input="mysiteStore.noDiscount = false"
                    class="input_dashboard_search max-md:!px-[15px] w-full text-darkGrey dark:text-whiteTamkin !h-[40px]"
                    v-model="mysiteStore.promo" :placeholder="$t('Promo Code')" :class="[
                  ...
                  <div
                    ...
                    <div class="text-[13px] md:text-[15px] font-[500] text-darkGrey dark:text-white/70">
                      <span class="text-[#021328] font-[700] dark:text-white">{{ mysiteStore.currentDiscount }}%</span>
                      {{ $t("Discount") }} (-${{ percentageOff.toFixed(0) }})
                    </div>
                    <img src="/assets/imgs/promo_valid_.svg" class="max-md:w-[18px]" />
                  </div>
                  <div v-if="mysiteStore.isPromoFilled && !mysiteStore.noDiscount" @click="clearInput"
                ...
                <div class="text-center mt-[24px] w-auto md:w-2/6">
                  <button class="btn-dashboard max-md:!text-[13px] hover_tamkin w-full mx-auto text-center text-nowrap"
                    @click="mysiteStore.addPromoCode" :disabled="!mysiteStore.promo || mysiteStore.loadingPromo"
                    v-if="!mysiteStore.validPromo">
                    <div class="flex items-center justify-center">
                      ...
                      <svg v-if="mysiteStore.loadingPromo" class="animate-spin h-5 w-5 text-white"
              ...
              <div v-if="mysiteStore.noDiscount"
              ...
              <tbody>
                ...
                <tr class="text-[16px] leading-[24px] font-[500] bg-[#FAFCFE] dark:bg-tamkinDarkPrimary">
                  ...
                  <td
                    ...
                    colspan="2">
                    ${{
                      (Number(mysiteStore.packagePayload.total) - percentageOff)
                        .toFixed(0)
                        .toString()
                        .replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                    }}
