          ...
          <div class="flex flex-col items-center justify-center space-y-[12px] mx-auto w-full">
            <div
              ...
              <div class="text-center mt-[24px] w-auto md:w-2/6">
                ...
                <button v-else class="btn_bordered_dashboard max-md:!text-[13px] error text-nowrap w-auto md:w-[140px] mx-auto text-center"
            ...
            <table class="min-w-full">
              ...
              <tbody>
                ...
                <tr v-if="mysiteStore.validPromo"
