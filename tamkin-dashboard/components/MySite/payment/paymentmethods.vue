  ...
  <div v-if="isOpen('payment_methods_mysite')"
    ...
    <div class="w-full h-full">
      ...
      <div class="flex flex-col items-start justify-center w-full">
        ...
        <div class="flex items-center justify-between">
          <div
            class="close_btn_payment !cursor-pointer z-[999] dark:bg-tamkinDarkPrimary dark:text-whiteTamkin flex justify-center items-center -mt-2"
            style="box-shadow: 1px 0px 20.5px 0px #71dad2bd"
            @click="() => { closeModal('payment_methods_mysite'); mySiteStore.selectedPaymentMethod = '' }">
            <svg class="w-[12px] h-[12px]" width="12" height="12" viewBox="0 0 14 13" fill="none"
          ...
          <div @click="navigateTo('payment_methods_mysite', 'mysite', 'add_package_modal_mysite')" class="cursor-pointer close_sidebar_btn group flex items-center justify-center  
    ...
    ">
        ...
        <div
            ...
            flex items-center justify-between rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]">
                ...
                <div class="order-1 mx-[4px]">
                  <input id="radio5" type="radio" name="radio" class="hidden" value="by_card"
                    v-model="mySiteStore.selectedPaymentMethod"
                    :checked="mySiteStore.selectedPaymentMethod === 'by_card'" />
             ...
             rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]">
                ...
                <div class="order-1 mx-[4px]">
                  <input id="radio_crypto" type="radio" name="radio" class="hidden" value="by_crypto"
                    :disabled="mySiteStore.packagePayload.payDateType === 0" v-model="mySiteStore.selectedPaymentMethod"
                    :checked="mySiteStore.selectedPaymentMethod === 'by_crypto' && mySiteStore.currentPackage.trial_days === 0" />
            ...
            justify-between rounded-[10px] border-lightGrey dark:border-darkborder ltr:pl-[16px] rtl:pr-[16px]">
                ...
                <div class="order-1 mx-[4px]">
                  <input id="radio_paypal" type="radio" name="radio" class="hidden" value="by_paypal"
                    :disabled="mySiteStore.packagePayload.payDateType === 0" v-model="mySiteStore.selectedPaymentMethod"
                    :checked="mySiteStore.selectedPaymentMethod === 'by_paypal' && mySiteStore.currentPackage.trial_days === 0" />
          ...
          <div class="my-[26px] px-[20px] max-md:w-full md:rtl:mr-auto md:ltr:ml-auto">
            <button class="btn-dashboard hover_tamkin max-md:w-full" :disabled="!mySiteStore.selectedPaymentMethod"
              @click="goToPaymentMethod(mySiteStore.selectedPaymentMethod)">
