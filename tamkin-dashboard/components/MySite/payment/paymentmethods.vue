...
<template>
  <div
    v-if="isOpen('payment_methods_mysite')"
      ...
      <div class="flex flex-col items-start justify-center w-full">
        ...
        >
          ...
          >
            <div class="w-full">
              <div
                @click="mySiteStore.selectedPaymentMethod = 'by_card'"
                :class="[
                  mySiteStore.selectedPaymentMethod == 'by_card'
            ...
            <div class="w-full">
              <div
                ...
                :class="[
                  mySiteStore.selectedPaymentMethod == 'by_crypto' &&
                  mySiteStore.packagePayload.payDateType !== 'trial'
                    ? 'custom-border-tamkin'
                    : 'border-[1px] ',
              ...
              >
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    ...
                    class="hidden"
                    value="by_crypto"
                    :disabled="mySiteStore.packagePayload.payDateType === 0"
                    v-model="mySiteStore.selectedPaymentMethod"
                    :checked="
                      mySiteStore.selectedPaymentMethod === 'by_crypto' &&
          ...
          <div
            class="my-[26px] px-[20px] max-md:w-full md:rtl:mr-auto md:ltr:ml-auto"
          >
            <button
              class="btn-dashboard hover_tamkin max-md:w-full"
              :disabled="!mySiteStore.selectedPaymentMethod"
