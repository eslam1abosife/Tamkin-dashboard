  ...
  >
    ...
    <div class="mx-auto max-h-[100%] w-full mt-[-20px]">
      ...
      <div class="space-y-[26px] w-full mt-[32px] pb-[30px]">
        ...
        <div
          class="flex items-center justify-between flex-col sm:flex-row w-full space-x-[0px] rtl:space-x-reverse sm:space-x-[30px]"
        >
          <div class="w-full relative">
            <input
              type="text"
              placeholder=""
              id="account_number"
              class="input_floating_label !top-[12px] peer !h-[50px] w-full"
        ...
        <div
          class="flex items-center justify-between w-full rtl:space-x-reverse space-x-[30px]"
        >
          <div class="w-full relative">
            <input
              type="text"
