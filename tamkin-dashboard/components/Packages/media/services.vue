...
<template>
  <div class="flex flex-col items-center justify-center w-full">
    <div
      v-if="packagesStore.getAddonsOrExtras('Services').length"
    ...
    >
      ...
      <div
        class="flex items-center justify-center rtl:space-x-reverse space-x-[14px] px-[8px] mt-[46px]"
      >
        <div
        ...
        >
          <div
            class="flex items-center justity-center w-full rtl:space-x-reverse space-x-[13px] mt-[10px]"
          >
            <div>
              <img
          ...
          <div
            v-if="
              srv.package_price_role[0].discount_month !== 0 ||
              srv.package_price_role[0].discount_yearly !== 0
            "
          ...
          <div class="my-[8px]">
            ...
            ><span class="text-[10px] font-[500] leading-[15px] text-darkGrey"
