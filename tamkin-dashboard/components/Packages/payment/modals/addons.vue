...
<template>
  ...
  <div style="box-shadow: 1px 0px 20.5px 0px #71dad2bd" class="close_btn_payment !cursor-pointer z-[999]
   dark:bg-tamkinDarkPrimary dark:text-whiteTamkin" @click="closeModal('add_addons_modal_packages')">
    <svg
      class="w-[12px] h-[12px]"
      width="14"
      height="13"
    ...
    <div class="w-full h-full">
        ...
        <div class="flex flex-col items-start  justify-center w-full lg:overflow-x-hidden" >
            ...
            >
            <h1 class="pt-[24px] text-[16px] lg:text-[18px] leading-[36px] font-[600] text-darkGrey dark:text-whiteTamkin lg:px-0 px-[20px]  lg:mt-0 mt-[60px]">
                Your add-ons
            </h1>
            <div class=" h-[61px] w-full border-b  mt-[28px] flex items-center justify-start space-x-[18px] bg-[#EFF5FF]">
            <div class="pl-[5px]">
            ...
            <div class="text-[15px] font-[400] leading-[26px] !ml-auto pr-[5px] text-[#1E1E1E]">
                ...
                <div class="flex items-center justify-center w-full ">
                    <div class="order-2  w-full h-full">
                        <div
                            ...
                            class="absolute text-[13px] leading-[17.76px] font-[400] w-[103px] rounded-[10px] 
                            h-[22px] flex items-center justify-center py-[4.5] 
                            px-[0.5px] top-[-10px] rtl:right-[30%] ltr:left-[30%] text-white"
                        >
                            <span>Popular</span>
                        </div>
                ...
                <div class="flex items-center justify-center  w-full">
                  <div class="order-2  w-full">
                      <div
                        ...
                        class="absolute text-[13px] leading-[17.76px] font-[400] 
                        w-[134px]  rounded-[10px] h-[22px] flex items-center justify-center 
