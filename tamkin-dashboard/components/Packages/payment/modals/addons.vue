...
const geteFilterInfo = (level: any) => {
  levelTraffic.value = level;
};
const levelsTraffic = ref([
  {
    id: 1,
    name: "Up to 100 K  page views/ MO",
  },
  {
    id: 2,
    name: "Up to 200 K  page views/ MO",
  },
  {
    id: 3,
    name: "Up to 300 K  page views/ MO",
  },
]);
</script>
...
<template>
  <div
    class="mysite_bg_modal dark:bg-p fixed z-[9999] top-[0] lg:inset-auto inset-0 rtl:lg:left-0 ltr:lg:right-0 rounded-[10px] px-[16px] py-[30px] lg:px-[30px] lg:w-[803px] w-full h-full lg:h-screen overflow-y-auto lg:overflow-x-hidden"
  >
    <!-- v-if="isOpen('add_addons_modal_packages')" -->
    <div
      style="box-shadow: 1px 0px 20.5px 0px #71dad2bd"
      class="close_btn_payment !cursor-pointer z-[999] dark:bg-tamkinDarkPrimary dark:text-whiteTamkin"
      @click="closeModal('add_addons_modal_packages')"
    >
      <svg
        class="w-[12px] h-[12px]"
        width="14"
    ...
    <div class="w-full h-full">
      ...
      >
        ...
        >
          <h1
            class="pt-[24px] text-[16px] lg:text-[18px] leading-[36px] font-[600] text-darkGrey dark:text-whiteTamkin lg:px-0 px-[20px] lg:mt-0 mt-[60px]"
          >
            Your add-ons
          </h1>
          <div
          ...
          >
            <div class="pl-[5px]">
              <img src="/imgs/reader_.png" class="h-[45px] w-[45px]" alt="" />
            </div>
            ...
            <div
              class="text-[15px] font-[400] leading-[26px] !ml-auto pr-[5px] text-[#1E1E1E]"
            >
              ...
              <div class="flex items-center justify-center w-full">
                <div class="order-2 w-full h-full">
                  <div
                    ...
                    "
                    class="absolute text-[13px] leading-[17.76px] font-[400] w-[103px] rounded-[10px] h-[22px] flex items-center justify-center py-[4.5] px-[0.5px] top-[-10px] rtl:right-[30%] ltr:left-[30%] text-white"
                  >
                    <span>Popular</span>
                  </div>
              ...
              <div class="flex items-center justify-center w-full">
                <div class="order-2 w-full">
                  <div
                    ...
                    class="absolute text-[13px] leading-[17.76px] font-[400] w-[134px] rounded-[10px] h-[22px] flex items-center justify-center top-[-10px] left-[30%] text-white"
                  >
          ...
          >
            <div
              class="w-full 2xl:w-[520px] lg:w-[550px] 3xl:w-[500px] relative"
            >
              <input
                type="newWebsite"
