...
// watch(packagesStore.promo, (ov, nv) => {
//   return packagesStore.promo
//     ? (packagesStore.isPromoFilled = true)
//     : (packagesStore.isPromoFilled = false);
// });
const clearInput = () => {
  promo.value = "";
...
const selectCryptoMethod = (method) => {
  if (packagesStore.selectedCrypto !== method) {
...
onBeforeMount(async () => {
  ...
  const featuredRate = cryptostore.list.find((rate) => rate.is_featured === 1);
    ...
    if(!packagesStore.selectedCrypto) {
      packagesStore.selectedCrypto = featuredRate;
    }
  ...
  >
    ...
    <div class="w-full h-full">
      <div
        ...
        v-if="isModalOpen('crypto_packages_step1')"
      >
        <div class="flex items-center justify-center">
          <div
            @click="navigateTo('crypto_packages_step1', 'packages', 'payment_methods_packages')"
        ...
        >
          ...
          >
            <div class="flex flex-col items-center justify-center w-full px-[20px]">
              <div
                v-if="packagesStore.selectedCrypto"
              ...
              >
                ...
                >
                  ...
                  <div class="flex items-start flex-col justify-start space-y-[-4px]">
                    ...
                    >
                      {{ packagesStore.selectedCrypto.title }} - <span class="!font-[300]">{{ packagesStore.selectedCrypto.network}}</span>
                    </div>

                    <div
                      class="text-[#021328] text-[14px] font-[500] dark:text-whiteTamkin"
                      v-if="packagesStore.selectedCrypto && packagesStore.selectedCrypto.is_featured === 1"
                    >
                      {{ $t('Pay Via') }} {{ packagesStore.selectedCrypto.title }} {{$t('and get')}}
                      <span class="text-[14px] font-[700]"
                        >{{ packagesStore.selectedCrypto.discount }}%</span
                      >
                      {{$t('discount')}}
                    </div>
                  </div>
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    :id="'radio_' + packagesStore.selectedCrypto.name"
                    type="radio"
                    name="radio"
                    class="hidden"
                    :value="packagesStore.selectedCrypto.name"
                    @click=""
                    checked
                    number
                  />
                  <label
                    :for="'radio_' + packagesStore.selectedCrypto.name"
            ...
            <div class="flex items-center justify-between w-full px-[20px]">
              <div class="w-full mt-[20px]">
                <div class="relative w-full font-[Poppins]">
                  ...
                  >
                    <span class="floating_label" v-if="!packagesStore.selectedCrypto">{{
                    ...
                    >
                      ...
                      <div class="flex items-center justify-end">
                        <div class="rtl:mr-auto ltr:ml-auto">
                          ...
                          >
                          {{ cryptostore.rates[packagesStore.selectedCrypto.coingecko_id] }}
                        </div>
                        </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <!-- <span class="text-black font-[500] dark:text-whiteTamkin">
                            {{convertUsdToCryptos(packagesStore.cartTotal,cryptostore.rates)}} {{selectedCrypto.title}}</span> -->
                      {{
                        convertUsdToCrypto(
              ...
              >
                <div class="lg:py-[17px] search_input w-full lg:w-3/4 mt-[24px]">
                  ...
                  >
                    ...
                    <div class="text-[15px] font-[500] text-darkGrey dark:text-white/70">
                      <span class="text-[#021328] font-[700] dark:text-white">{{ packagesStore.currentDiscount }}%</span>
                ...
                <div class="text-center mt-[16px] lg:mt-[24px] w-2/6">
                  <button
                    ...
                    :disabled="!packagesStore.promo || packagesStore.loadingPromo"
                    v-if="!packagesStore.validPromo"
                  >
                  <div class="flex items-center justify-center">
                    ...
                    <svg  v-if="packagesStore.loadingPromo" class="animate-spin  h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              ...
              <tbody>
                ...
                >
                  <td
                    ...
                    colspan="2"
                  >
                    {{ $t('Promo Code') + ' : ' +packagesStore.currentDiscount +'%' }}
                  </td>
                  <td
                ...
                <tr
                  v-if="packagesStore.validPromo || (packagesStore.selectedCrypto && packagesStore.selectedCrypto.is_featured === 1)"
                  class="text-[14px] leading-[24px] font-[500] bg-[#FAFCFE] dark:bg-tamkinDarkPrimary"
                >
                  <td
          ...
          <div class="mt-[39px] mx-auto mb-[34px] px-[20px] w-full" v-if="!loadingData">
            <button
              ...
              :disabled="!packagesStore.selectedCrypto"
              @click="navigateTo('crypto_packages_step1', 'packages', 'crypto_packages_step2')"
            >
              {{ $t('Continue') }}
            </button>
          </div>
