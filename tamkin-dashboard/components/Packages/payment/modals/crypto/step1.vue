          ...
          >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="!font-[300]">{{
                        packagesStore.selectedCrypto.network
                      }}</span>
                    </div>
                    ...
                    <div
                      ...
                      v-if="
                        packagesStore.selectedCrypto &&
                        packagesStore.selectedCrypto.is_featured === 1
                      "
                    >
                      {{ $t("Pay Via") }}
                      {{ packagesStore.selectedCrypto.title }}
                      ...
                      <div class="flex items-center justify-end">
                        <div class="rtl:mr-auto ltr:ml-auto">
                          ...
                          >
                            {{
                              cryptostore.rates[
                                packagesStore.selectedCrypto.coingecko_id
                              ]
                            }}
                          </div>
                        </div>
            ...
            <table class="min-w-full">
              <thead>
                <tr>
                  <th
                    class="py-2 whitespace-nowrap ltr:pl-[20px] rtl:pr-[20px] border-b dark:border-darkborder dark:text-whiteTamkin text-[16px] leading-[30px] text-darkGrey font-[600] ltr:text-left rtl:text-right"
                    colspan="12"
                  >
                    {{ $t("Summary") }}
                  </th>
              ...
              <tbody>
                ...
                >
                  <td
                    class="py-2 whitespace-nowrap px-5 border-b dark:border-darkborder text-right font-[500] w-full dark:text-whiteTamkin"
                    colspan="2"
                  >
                    {{
                      $t("Promo Code") +
