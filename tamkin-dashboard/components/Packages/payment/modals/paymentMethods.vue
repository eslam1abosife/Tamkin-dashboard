...
const goToPaymentMethod = async (method: any) => {
  ...
  if( packagesStore.packagePayload.payDateType !== 0 ){
    ...
    // packagesStore.currentDiscount = 0;
    // packagesStore.validPromo = false;
    return navigateTo('payment_methods_packages', 'packages', 'paypal_packages')

    // const res = await createOrder('paypal')
    // console.log(res.headers.location)
  }
  if (packagesStore.selectedPaymentMethod === 'by_crypto') {
    // packagesStore.promo = "";
    // packagesStore.currentDiscount = 0;
    // packagesStore.validPromo = false;
...
<template>
  ...
  <div v-if="isOpen('payment_methods_packages')"
   ...
   dark:bg-tamkinDarkPrimary dark:text-whiteTamkin !top-[23px]" @click="()=>{
    closeModal('payment_methods_packages')
    ...
    <div class="w-full h-full">
      ...
      <div class="flex flex-col items-start justify-center w-full">
        ...
        <div class="flex items-center justify-center">
          <div @click="navigateTo('payment_methods_packages', 'packages', 'add_package_modal_packages')" 
    ...
    ">
        ...
        <div
          ...
          <div class="flex flex-col items-start justify-center space-y-[12px] mt-[50px] w-full px-[5px] lg:px-[20px]">
            ...
            <div class=" w-full ">
              <div @click="()=>{
                ...
                :class="[packagesStore.selectedPaymentMethod == 'by_crypto' &&  packagesStore.packagePayload.payDateType !== 0 ? 'custom-border-tamkin' : 'border-[1px] ',
            ...
            <div class=" w-full ">
              <div @click="()=>{
                ...
                :class="[packagesStore.selectedPaymentMethod == 'by_paypal'  && packagesStore.packagePayload.payDateType !== 0 ? 'custom-border-tamkin' : 'border-[1px] ',
                packagesStore.packagePayload.payDateType === 0  ?'!cursor-not-allowed opacity-50' :''
          ...
          <div class="my-[26px] px-[20px] rtl:mr-auto ltr:ml-auto">
            <button class="btn-dashboard hover_tamkin" :disabled="!packagesStore.selectedPaymentMethod" @click="goToPaymentMethod(packagesStore.selectedPaymentMethod)">
