      ...
      <div class="flex flex-col items-start justify-center w-full">
        ...
        >
          ...
          >
            <div class="w-full">
              <div
                @click="packagesStore.selectedPaymentMethod = 'by_card'"
                :class="[
                  packagesStore.selectedPaymentMethod == 'by_card'
              ...
              >
                ...
                <div class="order-1 mx-[30px]">
                  <input
                    ...
                    class="hidden"
                    value="by_card"
                    v-model="packagesStore.selectedPaymentMethod"
                    :checked="packagesStore.selectedPaymentMethod === 'by_card'"
                  />
                  <label
                    for="radio5"
          ...
          >
            <button
              ...
              @click="goToPaymentMethod(packagesStore.selectedPaymentMethod)"
            >
