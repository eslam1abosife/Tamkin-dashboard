...
const changeColor = computed(() => {
  ...
  return packagesStore.currentType.title === "Sign language"
    ? packagesStore.currentTabTitle === "Plugins"
      ? pageColor
      : tabColor // Use tab color if a tab is selected, otherwise use the page color
    : pageColor;
});
...
const getLinkbasedOnTitle = (type) => {
  switch (type.title) {
    ...
    case "Live Translation":
      return "/packages/live-translation";
    case "Investors":
      return "/packages/investors";
    case "Bundle":
...
<template>
  ...
  >
    ...
    <div
      class="absolute right-[14px] inset-y-[30px]"
      v-if="
        packagesStore.currentType.title === 'Sign language' &&
        packagesStore.currentTabTitle === 'Plugins'
      "
    ...
    >
      <img
        src="/imgs/live_translation_vector_1.png"
    ...
    >
      <img
        src="/imgs/investors_vector_1.png"
        class="w-[228px] h-[200px]"
        alt=""
      />
    </div>
    <div
      class="absolute right-[-21px]"
      v-if="packagesStore.currentType.title === 'Investors'"
    >
      <img
        src="/imgs/investor_vector_2.png"
        class="w-[228px] h-[200px]"
        alt=""
      />
    </div>
    ...
    <div
      ...
      v-if="packagesStore.currentType.title === 'Bundle'"
    >
      <img
        src="/imgs/bundle_page_vector_1.png"
        class="w-[131px] h-[131px]"
        alt=""
      />
    </div>
    <div
      class="absolute right-[30px] inset-y-[30px]"
      v-if="packagesStore.currentType.title === 'Bundle'"
    >
      <img
        src="/imgs/bundle_page_vector_3.png"
        class="w-[120px] h-[150px]"
        alt=""
      />
    </div>
    <div
      class="absolute inset-x-auto top-[16px]"
      v-if="packagesStore.currentType.title === 'Bundle'"
    >
      <img
        src="/imgs/bundle_page_vector_2.png"
        class="w-[222px] h-[177px]"
        alt=""
      />
    </div>
    ...
    <div
      class="absolute right-[14px] inset-y-[10px]"
      v-if="
        packagesStore.currentType.title === 'Sign language' &&
        packagesStore.currentTabTitle === 'Documents'
      "
    ...
    <div
      class="absolute right-[14px] inset-y-[20px]"
      v-if="
        packagesStore.currentType.title === 'Sign language' &&
        packagesStore.currentTabTitle === 'Images'
      "
    ...
    <!--- START OF Bundle  -->
    <div
      class="absolute left-[14px] bottom-[0]"
      v-if="
        packagesStore.currentType.title === 'Sign language' &&
        packagesStore.currentTabTitle === 'Bundle'
      "
    ...
    <div
      class="absolute inset-x-auto inset-y-6"
      v-if="
        packagesStore.currentType.title === 'Sign language' &&
        packagesStore.currentTabTitle === 'Bundle'
      "
    ...
    <div class="flex items-center justify-center flex-col my-[50px]">
      ...
      <div
        class="flex items-center justify-center w-[100%] overflow-y-auto rtl:space-x-reverse space-x-[22px] absolute bottom-0"
      >
        <div
          v-for="linkPackage in packagesStore.types
            .filter((t) => t.title !== 'Live Translation')
            .sort((a, b) => a.sort - b.sort)"
          :key="linkPackage.name"
          :class="[
            packagesStore.currentType.title === linkPackage.title
              ? 'bg-[#FFFFFF61]/[38%]'
              : '',
          ]"
        ...
        >
          <div>
            <img
              :src="`https://tamkin.app/${linkPackage.icon}`"
              class="w-[28px] h-[17px]"
              alt=""
            />
          </div>
          <div class="text-[12px] font-[500] text-white">
            {{ $t(linkPackage.title) }}
          </div>
        </div>
