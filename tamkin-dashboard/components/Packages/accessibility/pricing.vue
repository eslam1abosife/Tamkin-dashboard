...
const dosomething = (p, contact) => {
  ...
  if (
    ...
    packagesStore.bundleSelectedPackage.title
  ) {
      ...
      <SplideSlide v-for="pak in filteredPackages" :key="pak">
        ...
        <div class="flex items-center justify-center w-full px-[15px] mt-[48px]">
          <div class="order-2 w-full">
            <h1 class="font-[600] text-[18px] leading-[30px] dark:text-whiteTamkin dark:text-whiteTamkin">
              {{ $t(pak.title) }}
            </h1>
            <h2
            ...
            <div v-if="packagesStore.traffic_level === 'Over 1M page views/mo'" class="my-[24px]"></div>
            <div v-if="
              packagesStore.traffic_level !== 'Over 1M page views/mo' &&
            ...
            <p class="font-[700] text-[12px] leading-[32px] text-darkGrey dark:text-whiteTamkin dark:text-whiteTamkin">
        ...
        <div
          ...
          <div class="flex items-center justify-center mx-auto w-full">
            <button @click="dosomething(pak, pak.is_contact_us)"
              ...
              ">
                {{
                  pak.trial_days > 0 ? `${$t("Free Trial")}` : $t("Get Started")
                }}
              </span>
