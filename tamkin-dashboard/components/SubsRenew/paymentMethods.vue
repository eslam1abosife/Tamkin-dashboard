...
<template>
  <div
    v-if="isOpen('payment_methods_subs')"
      ...
      <div class="flex flex-col items-start justify-center w-full">
        ...
        >
          ...
          >
            <div class="w-full">
              <div
                @click="subsStore.selectedPaymentMethod = 'by_card'"
                :class="[
                  subsStore.selectedPaymentMethod == 'by_card'
              ...
              >
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    ...
                    class="hidden"
                    value="by_card"
                    v-model="subsStore.selectedPaymentMethod"
                    :checked="subsStore.selectedPaymentMethod === 'by_card'"
                  />
                  <label
                    for="radio5"
            ...
            <div class="w-full">
              <div
                ...
                :class="[
                  subsStore.selectedPaymentMethod == 'by_crypto' &&
                  subsStore.packagePayload.payDateType !== 'trial'
                    ? 'custom-border-tamkin'
                    : 'border-[1px] ',

                  subsStore.packagePayload.payDateType === 0
              ...
              >
                ...
                <div class="order-1 mx-[4px]">
                  <input
                    ...
                    class="hidden"
                    value="by_crypto"
                    :disabled="subsStore.packagePayload.payDateType === 0"
                    v-model="subsStore.selectedPaymentMethod"
                    :checked="
                      subsStore.selectedPaymentMethod === 'by_crypto' &&
                      subsStore.currentPackage.trial_days === 0
                    "
                  />
                  <label
                    for="radio_crypto"
...
<<<<<<< HEAD
          <div class="my-[26px] px-[20px] rtl:mr-auto ltr:ml-auto">
            <button
              ...
              :disabled="!subsStore.selectedPaymentMethod"
