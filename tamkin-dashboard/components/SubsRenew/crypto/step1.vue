        ...
        >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="!font-[300]">{{
                        subsStore.selectedCrypto.network
                      }}</span>
                    </div>
                    ...
                    <div
                      ...
                      "
                    >
                      {{ $t("Pay Via") }} {{ subsStore.selectedCrypto.title }}
                      {{ $t("and get") }}
                      ...
                      <div class="flex items-center justify-end">
                        <div class="rtl:mr-auto ltr:ml-auto">
                          ...
                          >
                            {{
                              cryptostore.rates[
                                subsStore.selectedCrypto.coingecko_id
                              ]
                            }}
                          </div>
                        </div>
                ...
                <div class="text-center mt-[16px] lg:mt-[24px] w-2/6">
                  ...
                  >
                    <div class="flex items-center justify-center">
                      <div
                        :class="
                          subsStore.loadingPromo ? 'rtl:ml-2 ltr:mr-2' : ''
                        "
                      >
                        {{ $t("Apply code") }}
                      </div>
          ...
          >
            <button
              ...
              @click="
                navigateTo('crypto_subs_step1', 'subs', 'crypto_subs_step2')
              "
            >
              {{ $t("Continue") }}
            </button>
