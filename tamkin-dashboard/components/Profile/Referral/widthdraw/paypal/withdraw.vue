...
<template>
  ...
  >
    ...
    <div class="mx-auto max-h-[100%] w-full mt-[-20px]">
      ...
      >
        {{ $t("Enter your PayPal email address") }}
      </p>
      ...
      <div class="space-y-[26px] w-full mt-[32px] pb-[30px]">
        <div class="w-full relative">
          <input
            ...
            v-model="v$.paypalEmail.$model"
            :class="{
              input_error:
                (v$.paypalEmail.$error && v$.paypalEmail.required.$invalid) ||
                (v$.paypalEmail.$error && v$.paypalEmail.email.$invalid),
          ...
          >
            <p class="error_message">
              <span
                v-if="v$.paypalEmail.$error && v$.paypalEmail.required.$invalid"
                >{{ $t("Paypal Email is Invalid") }}</span
              >
              <span
                v-if="v$.paypalEmail.$error && v$.paypalEmail.email.$invalid"
                >{{ $t("Paypal Email is Invalid") }}</span
              >
            </p>
          </div>
