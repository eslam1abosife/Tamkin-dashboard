  ...
  >
    ...
    <div class="mx-auto max-h-[100%] w-full mt-[-20px]">
      ...
      >
        <!-- Icon Column -->
        <div
          class="col-span-1 w-[39px] h-[39px] flex items-center justify-center"
        >
          <img
        ...
        <div class="flex flex-col col-span-5 md:col-span-4 ms-4">
          ...
          <div
            class="text-[#021328] text-[10px] font-[500] mt-1 dark:text-whiteTamkin"
          >
      ...
      <div
        class="mt-2 text-[13px] font-[500] text-darkGrey leading-[15px] dark:text-whiteTamkin"
      >
      ...
      <div class="mt-4 mx-auto text-center relative">
        <input
          ...
          v-model="amount"
          @input="formatAmount"
          class="mx-auto focus:outline-none dark:bg-p dark:text-whiteTamkin focus:border-0 focus:ring-0 text-[#021328] font-[600] border-0 text-center"
          placeholder="0"
        />
      </div>
      ...
      >
        ...
        <span class="!font-[500] dark:text-whiteTamkin"
          >$ {{ withdrawStore.currentAmount }}</span
        >
      </div>
