...
const { t } = useI18n();
const { changeAccountPassword, errorFields, loading } =
...
const oldPassfieldType = computed(() =>
  isOldPassVisible.value ? "text" : "password"
);
...
<template>
  <div class="flex flex-col h-full w-full p-0 md:p-4">
    ...
    <div class="flex-grow">
      ...
      <div class="space-y-[23px] w-full flex flex-col items-center mt-[20px]">
        ...
        <div class="relative w-full">
          ...
          <label
            for="oldpass"
            class="floating_label mr-2"
            :class="[
              (v$.oldpass.$error && v$.oldpass.required.$invalid) ||
              (errorFields.length > 0 &&
                errorFields[0].field === 'old_password')
                ? '!text-error'
                : '',
            ]"
          >
          ...
          >
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="svg_eye ml-[-25px] mt-[5px] lg:mt-[0px]"
            >
              <path
          ...
          <div class="password_eye" v-else @click="toggleOldPassVisible">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div
            ...
            v-if="v$.oldpass.$error && v$.oldpass.required.$invalid"
          >
        ...
        <div class="relative w-full">
          ...
          <div class="w-full lg:w-4/6" v-if="isDuplicatePassword">
            <p class="error_message_password">
              <span>
                {{
                  $t("New password cannot be the same as the old password")
                }}</span
              >
            </p>
          </div>
    ...
    <div class="mt-auto md:rtl:mr-auto md:ltr:ml-auto">
      <button
        class="btn-dashboard hover_tamkin w-full sm:w-[200px] mt-[24px]"
