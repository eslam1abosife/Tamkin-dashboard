...
<template>
  <div
    class="shadow-md -shadow-y-[1px] bg-gradient-to-r custom-border rounded-big4x from-[#E5D5FA]/60 to-[#F8D3E0]/60 p-8 rounded-[43px] mt-[6px] w-full"
  >
    <h1
      class="text-[18px] leading-[30px] font-[600] text-[#1E1E1E] mb-6 mt-[16px]"
    >
