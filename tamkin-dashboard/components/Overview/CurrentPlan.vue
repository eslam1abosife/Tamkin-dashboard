        ...
        >
          ...
          >
            <div>
              <!-- Title Placeholder -->
              <div
                class="h-[30px] w-3/4 bg-gray-400 dark:bg-gray-700 rounded-md mb-2"
              ></div>
              <!-- Subtitle Placeholder -->
              <div
                class="h-[21px] w-2/3 bg-gray-400 dark:bg-gray-700 rounded-md"
              ></div>
            </div>
            ...
            >
              ...
              >
                <!-- Icon Placeholder -->
                <div
                  class="h-[22px] w-[22px] lg:h-[10px] lg:w-[10px] bg-gray-500 dark:bg-gray-800 rounded-full"
                ></div>
                <!-- Text Placeholder -->
                <div
                  class="h-[22px] w-[150px] bg-gray-400 dark:bg-gray-600 rounded-md"
                ></div>
              </div>

              <!-- Status Placeholder -->
              <div
                class="h-[25px] lg:w-[88px] bg-gray-500 dark:bg-gray-700 rounded-[17px]"
              ></div>
            </div>
          </div>
        </div>
