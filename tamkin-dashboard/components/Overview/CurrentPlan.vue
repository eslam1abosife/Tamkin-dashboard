...
<template>
  <div class="mt-[64px] bg-white dark:bg-tamkinDarkPrimary rounded-[10px] h-full shadow-md -shadow-y-[1px]">
    <div class="flex flex-col items-start justify-start w-full lg:overflow-x-hidden">
      <div v-if="!loadingPacks"
        ...
        <div
          ...
          <div class="flex flex-col items-start justify-center w-full px-[15px]">
            ...
            "
              ...
              <div v-if="getCurrentAccessPackage.status === 'Active'"
              ...
              <div v-if="getCurrentAccessPackage.status === 'Pending'"
            ...
            <div v-else
              class="h-[55px] px-[20px] bg-white dark:bg-darkTamkin bg-opacity-75 rounded-[41px] space-x-[42px] flex items-center justify-between rtl:space-x-reverse p-2 mt-[24px] w-full">
              <div class="flex items-center justify-start rtl:space-x-reverse space-x-[8px] w-full">
                <div></div>
                <div
                  class="text-[10px] lg:text-[14px] font-[500] ipad-max:text-[12px] ipad-max:leading-[10px] whitespace-nowrap lg:leading-[22.5px] text-darkGrey dark:text-white">
          ...
          <div class="rtl:mr-auto rtl:scale-x-[-1] ltr:ml-auto h-full w-full lg:block hidden">
            <img :src="`/assets/imgs/overview/${navStore.isDark
        ...
        <MySitePricing v-if="!loadingPacks" :current-package="getCurrentAccessPackage ? getCurrentAccessPackage : {}
          " :current-pack-id="getCurrentAccessPackage?.name" v-show="!isActivePackage" />
      </div>

      <div class="w-full bg-white dark:bg-tamkinDarkPrimary rounded-[10px] h-full shadow-md -shadow-y-[1px]"
        v-if="loadingPacks">
        <div
          class="flex items-center justify-start rounded-[10px] h-[212px] w-full animate-pulse bg-gray-300 dark:bg-gray-600">
          <div class="flex flex-col items-start justify-center w-full px-[15px]">
            <div>
              <!-- Title Placeholder -->
              <div class="h-[30px] w-3/4 bg-gray-400 dark:bg-gray-700 rounded-md mb-2"></div>
              <!-- Subtitle Placeholder -->
              <div class="h-[21px] w-2/3 bg-gray-400 dark:bg-gray-700 rounded-md"></div>
            </div>

            <!-- Placeholder for the Plan Information -->
            <div
              class="h-[55px] px-[20px] bg-gray-400 dark:bg-gray-700 rounded-[41px] space-x-[42px] flex items-center justify-between w-auto p-2 mt-[24px]">
              <div class="flex items-center justify-start rtl:space-x-reverse space-x-[4px]">
                <!-- Icon Placeholder -->
                <div class="h-[22px] w-[22px] lg:h-[10px] lg:w-[10px] bg-gray-500 dark:bg-gray-800 rounded-full"></div>
                <!-- Text Placeholder -->
                <div class="h-[22px] w-[150px] bg-gray-400 dark:bg-gray-600 rounded-md"></div>
              </div>

              <!-- Status Placeholder -->
              <div class="h-[25px] lg:w-[88px] bg-gray-500 dark:bg-gray-700 rounded-[17px]"></div>
            </div>
          </div>
        </div>
            ...
            <div v-for="n in 3" :key="n"
              ...
              <div class="flex items-center justify-center w-full px-[15px] mt-[48px]">
                <div class="w-full">
                  ...
                  <div class="bg-gray-300 dark:bg-gray-600 h-[20px] w-[150px] rounded mb-[16px]"></div>
                  <div class="bg-gray-300 dark:bg-gray-600h-[29px] w-[100px] rounded"></div>
                  <div class="bg-gray-200 dark:bg-gray-600 h-[16px] w-[120px] mt-[10px] rounded"></div>
                  <div class="bg-gray-200 dark:bg-gray-600 h-[16px] w-[80px] mt-[10px] rounded"></div>
                </div>
              </div>
              ...
              <div class="flex flex-col items-start justify-center w-full space-y-[10px] p-4">
                ...
                <div class="bg-gray-200 dark:bg-gray-600 w-full h-[40px] rounded-[19px] mt-[20px]"></div>
              </div>
            </div>
          </div>
        </div>
