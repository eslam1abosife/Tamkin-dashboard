...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="flex items-center justify-start rounded-[10px] h-[212px] w-full animate-pulse bg-gray-300"
        >
          <div
            class="flex flex-col items-start justify-center w-full px-[15px]"
          >
            ...
            >
              ...
              >
                <!-- Icon Placeholder -->
                <div
                  class="h-[22px] w-[22px] lg:h-[10px] lg:w-[10px] bg-gray-500 rounded-full"
                ></div>
                <!-- Text Placeholder -->
              ...
              <!-- Status Placeholder -->
              <div
                class="h-[25px] lg:w-[88px] bg-gray-500 rounded-[17px]"
              ></div>
            </div>
          </div>
        </div>
