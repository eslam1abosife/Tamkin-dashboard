...
const getImageUrl = computed(() => {
  ...
  return `/imgs/${props.icon}`;
});

watch(()=>props.showModal,()=>{

setTimeout(()=>{
    return modalStore.showSuccessModalContact = false
...
<template>
 ...
 <div class="flex flex-col items-center justify-center">
    ...
    <h2 class="text-center text-[14px] font-[500] leading-[24px] text-darkGrey dark:text-white">
