  ...
  <div class="!px-0 w-full relative">
    ...
    <div class="w-full relative px-[40px]" v-if="packagesStore.loadingData">
      <div class="flex flex-col items-center justify-center w-full mt-[26px]">
        <!-- Title Skeleton -->
        <div
          class="h-[30px] w-2/4 bg-gray-300 rounded-lg animate-pulse mb-2 dark:bg-p"
        ></div>

        <!-- Description Skeleton -->
        <div
          class="h-[20px] w-3/4 bg-gray-300 rounded-lg animate-pulse mb-4 dark:bg-p"
        ></div>
      </div>
      ...
      >
        ...
        >
          <!-- Icon Skeleton -->
          <div
            class="w-[50px] h-[50px] bg-gray-300 dark:bg-p rounded-full mb-4"
          ></div>
          <!-- Title Skeleton -->
          <div
            class="h-[30px] w-[150px] bg-gray-300 dark:bg-p rounded-lg mb-2"
          ></div>
          <!-- Subtitle Skeleton -->
          <div
            class="h-[15px] w-[100px] bg-gray-300 dark:bg-p rounded-lg mb-4"
          ></div>
          <!-- Price Skeleton -->
          <div
            class="h-[29px] w-[120px] bg-gray-300 dark:bg-p rounded-lg mb-2"
          ></div>
          <!-- Description Skeleton -->
          <div
            class="h-[32px] w-[200px] bg-gray-200 dark:bg-p rounded-lg mb-4"
          ></div>
          <!-- Features Skeleton -->
          <div class="flex flex-col space-y-2">
            <div
              class="h-[20px] w-[150px] bg-gray-200 dark:bg-p rounded-lg"
            ></div>
            <div
              class="h-[20px] w-[150px] bg-gray-200 dark:bg-p rounded-lg"
            ></div>
          ...
          <!-- Button Skeleton -->
          <div
            class="w-[205px] h-[48px] bg-gray-300 dark:bg-p rounded-[19px] mt-4"
          ></div>
        </div>
