...
<<<<<<< HEAD
    ...
    >
      <div
        class="flex w-full flex-col items-start justify-start space-y-[10px]"
      >
        <ProfileOwner
          v-if="
            profileStore.currentTab === 'personal' ||
...
>>>>>>> fb5a24abc521c4c3c17542315d6226286e4dfe70
        ...
        <div
          v-if="
            ...
            !loadingInvestor
          "
          class="bg-white/60 dark:bg-tamkinDarkPrimary rounded-[10px] backdrop-blur-md shadow-sm h-auto flex flex-col items-start justify-start p-[15px] ipad-max:w-full w-full relative"
        >
          <div
            class="absolute bg-gradient-to-br from-[#FBC558] to-[#F7AAFD] w-full h-[160px] rounded-full right-0 left-1/4 opacity-30 blur-xl z-[-1]"
          ></div>
...
>>>>>>> fb5a24abc521c4c3c17542315d6226286e4dfe70
        >
          ...
          <div class="flex items-center w-full mt-[7px]">
            <div
              class="relative w-[85%] overflow-visible h-[8px] bg-[#E7ECEB] rounded-[9px]"
            >
              <div
                v-if="!profileStore.loadingProfile"
      ...
      <div
        class="w-full bg-white/60 shadow-sm rounded-[10px] col-span-8 md:px-[30px] px-[10px] pt-[16px] backdrop-blur-md flex flex-col items-start justify-start space-y-[10px] dark:bg-tamkinDarkPrimary"
      >
        <div class="flex items-start justify-between w-full">
          ...
          <div
            ...
            class="text-[12px] md:text-[14px] font-[500] leading-[24px] dark:text-whiteTamkin border-b-[3px] border-transparent pb-[6px] cursor-pointer"
          ...
          <div
            ...
            class="text-[12px] md:text-[14px] font-[500] leading-[24px] border-b-[3px] dark:text-whiteTamkin border-transparent pb-[6px] cursor-pointer"
