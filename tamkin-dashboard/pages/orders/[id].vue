...
<template>
  <div class="w-full relative">
    ...
    <div class="space-y-[5px]">
      ...
      <h2
        @click="$router.push({ path: localePath('/orders') })"
    ...
    >
      ...
      <div class="h-[20px] dark:bg-p bg-gray-300 rounded w-1/6 mt-[41px]"></div>
        ...
        <template v-for="index in 3" :key="index">
          ...
          >
            <div class="flex items-center rtl:space-x-reverse space-x-4">
              ...
              <div class="space-y-2">
                <div
                  class="h-[20px] dark:bg-p bg-gray-300 rounded w-[60px]"
                ></div>
                <div
                  class="h-[16px] dark:bg-p bg-gray-300 rounded w-[100px]"
                ></div>
                <div
                  class="h-[16px] dark:bg-p bg-gray-300 rounded w-[80px]"
                ></div>
              </div>
            </div>
            <div class="h-[20px] dark:bg-p bg-gray-300 rounded w-[50px]"></div>
          </div>
        </template>
      </div>
      <div class="pb-[10px]">
        <table class="min-w-full">
          <tbody>
            ...
            >
              ...
              >
                <div
                  class="h-[16px] dark:bg-p bg-gray-300 rounded w-[80px] ml-auto"
                ></div>
              </td>
              <td
              ...
              >
                <div
                  class="h-[16px] dark:bg-p bg-gray-300 rounded w-[50px] ml-auto"
                ></div>
              </td>
            </tr>
            <tr
            ...
            <tr class="text-[14px] leading-[24px] bg-[#FAFCFE] dark:bg-p">
              ...
              >
                <div
                  class="h-[16px] dark:bg-tamkinDarkPrimary bg-gray-300 rounded w-[80px] ml-auto"
                ></div>
              </td>
              <td
                class="py-2 border-b dark:border-darkborder text-right w-full font-[500] dark:text-whiteTamkin"
              ...
              >
                <div
                  class="h-[16px] dark:bg-tamkinDarkPrimary bg-gray-300 rounded w-[50px] ml-auto"
                ></div>
              </td>
            </tr>
          </tbody>
    ...
    <div
      class="w-full flex flex-col items-evenly justify-evenly px-[20px] h-full dark:bg-tamkinDarkPrimary bg-white mt-[20px] rounded-[10px]"
      v-else
    >
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <svg
                v-if="loadingInvoiceId === orderDetails.order_id"
                class="animate-spin h-4 w-4 text-tamkin"
        ...
        >
          <img
            v-if="orderDetails"
            :src="getPaymentImage(orderDetails.Payment_Method)"
          ...
          <img
            :class="
              ...
              orderDetails.status === 'Cancelled'
                ...
                : ''
            "
            :src="getStatusImage(orderDetails.status)"
            class="w-[32px] h-[32px] ipad-max:w-[16px] ipad-max:h-[16px]"
            alt=""
          />
      ...
      <div class="space-y-4 mt-[10px]">
        <template v-for="item in orderDetails.items" :key="item.name">
          ...
          >
            <div class="flex items-center rtl:space-x-reverse space-x-4">
                ...
                <img
                  :src="
                    item.type !== 'Custom Character'
                      ...
                      : '/assets/pngs/market/special_character.png'
                  "
                  :alt="
                    item.type !== 'Custom Character'
                      ? item.name
              ...
              <div>
                ...
                >
                  <div>
                    <img
                      :src="`https://tamkin.app/${item.category_image}`"
                      alt="Top"
                      class="w-[26px] h-[26px]"
                    />
                  </div>
                ...
                <div
                  v-if="item.type == 'Custom Character'"
            ...
            <div
              class="flex items-end flex-col justify-start mt-[16px] mr-[1px]"
            >
              <p
                class="text-[#021328] text-[16px] font-[500] dark:text-whiteTamkin uppercase"
              >
                <span class="px-1"
                  >{{ item.Cost }}
                  {{
                    $t(orderDetails.Currency ? orderDetails.Currency : "USD")
                  }}</span
                >
              </p>
            </div>
      ...
      <div class="pb-[10px]">
        <table class="min-w-full">
          <tbody>
            ...
            <tr
              class="text-[14px] leading-[24px] bg-[#FAFCFE] dark:bg-p"
              ...
              >
                {{
                  convertUsdToCrypto(
                    orderDetails.total,
                    cryptoStore.rates,
                    orderDetails.coingecko_id
                  )
                }}
                {{ orderDetails.crypto_title }}
              </td>
            </tr>
            <tr class="text-[14px] leading-[24px] bg-[#FAFCFE] dark:bg-p">
              <td
