  ...
  <div class="w-full relative">
    ...
    <div class="space-y-[10px]">
      ...
      >
        {{
          $t(
            "Payments & Invoices offer a detailed record of your payments and charges for easy financial tracking"
          )
        }}
      </h2>
    </div>
        ...
        >
          ...
          >
            ...
            <path
              ...
              fill="url(#paint1_linear_9024_12875)"
            />
            <defs>
              <linearGradient
          ...
          <tbody class="text-gray-700">
            ...
            >
              ...
              >
                ...
                >
                  <button
                    @click="GetBase64AndPrint(invoice.name)"
                    :disabled="loadingInvoiceId === invoice.name"
                    class="text-[14px] font-[500] leading-[19px]"
                    :class="
                      loadingInvoiceId === invoice.name
                  ...
                  <svg
                    v-if="loadingInvoiceId === invoice.name"
