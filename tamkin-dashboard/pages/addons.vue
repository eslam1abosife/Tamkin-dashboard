...
<template>
  <div class="relative h-full w-full">
    ...
    <div class="w-full h-full relative">
      <HeaderAccess :section-title="$t('Addons')" :section-sub-title="$t(
      ...
      <div v-if="customizeStore.loadingData || navStore.loadingdefaultappobj">
        <div class="animate-pulse space-y-4 card dark:bg-tamkinDarkPrimary bg-white rounded-[10px] mt-[40px] p-4">
          <div class="h-[55px] w-full dark:bg-p rounded-md bg-gray-200" v-for="s in 6" :key="s"></div>
        </div>
        <div class="animate-pulse dark:bg-tamkinDarkPrimary space-y-4 mt-2 card bg-white rounded-[10px] mt-[30px] p-4">
          <div class="h-[55px] w-full dark:bg-p rounded-md bg-gray-200" v-for="s in 6" :key="s"></div>
        </div>
      </div>
      ...
      <div v-else>
        ...
        <div v-else>
          ...
          <div id="live"
            ...
            <div class="lg:px-[25px] mt-[64px] md:px-[25px] p-[17px]" v-if="
              horizontalView &&
                ...
                <SplideSlide v-for="pak in livePackages" :key="pak.name" class="!mt-[34px]">
                  <div :class="[
                    ...
                    <button @click="
                      ...
                      " :disabled="loadingBlock.find((a) => a === pak.name)" :class="[
                      navStore.defaultappobj?.package?.find(
                        (t) => t.type === 'Live Translation'
                      )?.name === pak.name
                      ...
                      <svg v-if="loadingBlock.find((a) => a === pak.name)" class="animate-spin h-5 w-5 mx-1 text-white"
            ...
            <div
              ...
              v-if="
                ...
                !collapseStore.collapses.includes('LiveTranslationAddonsCard')
              ">
              <div v-for="pak in livePackages" :key="pak.name"
